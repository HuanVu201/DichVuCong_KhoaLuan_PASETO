...
namespace TD.DichVuCongApi.Infrastructure.Caching;
...
public class LocalCacheService : ICacheService
{
    ...
    public void Set<T>(string key, T value, TimeSpan? slidingExpiration = null)
    {
        ...
        var absoluteExpiration =  slidingExpiration != null ? (TimeSpan)slidingExpiration : TimeSpan.FromMinutes(5); // Default expiration time of 10 minutes.

        _cache.Set(key, value, new MemoryCacheEntryOptions { AbsoluteExpiration = DateTimeOffset.UtcNow.Add(absoluteExpiration) });
