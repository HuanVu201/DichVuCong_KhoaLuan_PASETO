...
using TD.DichVuCongApi.Infrastructure.Persistence.ConnectionString;
...
using TD.DichVuCongApi.Infrastructure.Utilities;
using TD.DichVuCongApi.Infrastructure.Common.Services;

namespace TD.DichVuCongApi.Infrastructure.Persistence;
...
internal static class Startup
{
    ...
    internal static IServiceCollection AddPersistence(this IServiceCollection services)
    {
        services.AddOptions<DatabaseSettings>()
            ...
            {
                if (databaseSettings.ConnectionString.StartsWith("Crypt:"))
                {
                    databaseSettings.ConnectionString = databaseSettings.ConnectionString.Replace("Crypt:", string.Empty);
                    databaseSettings.ConnectionString = Encryption.Decrypt(databaseSettings.ConnectionString);
                }
