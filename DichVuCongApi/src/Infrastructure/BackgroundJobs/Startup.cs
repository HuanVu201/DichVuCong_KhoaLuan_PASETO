...
internal static class Startup
{
    ...
    {
        var settings = config.GetSection(nameof(HangfireSettings)).Get<HangfireSettings>();
        if (settings.Enable is true)
        {
            ...
            //services.AddSingleton<JobActivator, TDJobActivator>();
            ...
            //    .UseFilter(new TDJobFilter(provider))
            ...
            //        DelaysInSeconds = new int[2] { 300, 600 }
            //    })
            //    .UseConsole());
