...
public class DeleteQuyTrinhXuLyCommandHandler : ICommandHandler<DeleteQuyTrinhXuLyCommand>
{
    private readonly IRepository<QuyTrinhXuLy> _repositoryWithEvents;
    public DeleteQuyTrinhXuLyCommandHandler(IRepository<QuyTrinhXuLy> repositoryWithEvents) => _repositoryWithEvents = repositoryWithEvents;
