...
public class RestoreDanhGiaHaiLongCommandHandler : ICommandHandler<RestoreDanhGiaHaiLongCommand>
{
    private readonly IRepository<DanhGiaHaiLong> _repositoryWithEvents;
    public RestoreDanhGiaHaiLongCommandHandler(IRepository<DanhGiaHaiLong> repositoryWithEvents) => _repositoryWithEvents = repositoryWithEvents;
    public async Task<Result> Handle(RestoreDanhGiaHaiLongCommand request, CancellationToken cancellationToken)
    {
