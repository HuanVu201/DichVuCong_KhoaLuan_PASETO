...
public class SearchHoSoCanBoBCCIRequest : PaginationFilter, IRequest<PaginationResponse<HoSoDto>>
{
    public string? MaLinhVucChinh { get; set; }
    public DateTime? TiepNhanFrom { get; set; }
    public DateTime? TiepNhanTo { get; set; }
    ...
    public bool? TraKqWithItemCode { get; set; }
}
