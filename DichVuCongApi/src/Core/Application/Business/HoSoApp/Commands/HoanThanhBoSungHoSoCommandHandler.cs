...
public class HoanThanhBoSungHoSoCommandHandler : ICommandHandler<HoanThanhBoSungHoSoCommand>
{
    ...
    public HoanThanhBoSungHoSoCommandHandler(INguoiXuLyHoSoService nguoiXuLyHoSoService, IHoSoServices hoSoServices, IReadRepository<NgayNghi> ngayNghiRepository, IInjectConfiguration injectConfiguration, IDapperRepository dapperRepository, ICurrentUser user, IRepository<HoSo> repositoryHoSo, IRepository<QuaTrinhXuLyHoSo> repositoryQuaTrinhXuLyHoSo)
    {
    ...
    public async Task<Result> Handle(HoanThanhBoSungHoSoCommand request, CancellationToken cancellationToken)
    {
        ...
        var sqlUpdateHoSoBoSung = @"UPDATE Business.HoSoBoSungs SET TrangThaiBoSung= @TrangThaiBoSung, NguoiTiepNhanBoSung = @NguoiTiepNhanBoSung,
        ...
        if (maTrangThaiHienTai == "5" && hoSo.NguoiDangXuLy.ToLower().Contains(userId.ToString().ToLower()))
        {
            ...
            try
            {
                ...
                var updatedHoSoBoSungRows = await _dapperRepository.ExcuteAsync(sqlUpdateHoSoBoSung, new
                {
                    ...
                    NgayHenTraMoi = updatedHoSo.NgayHenTra,
                    Id = hoSoBoSung.Id,
                });
