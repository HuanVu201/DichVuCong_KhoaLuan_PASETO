...
public class RestoreThongBaoCommandHandler : ICommandHandler<RestoreThongBaoCommand>
{
    private readonly IRepositoryWithEvents<ThongBao> _repositoryWithEvents;
    public RestoreThongBaoCommandHandler(IRepositoryWithEvents<ThongBao> repositoryWithEvents) => _repositoryWithEvents = repositoryWithEvents;
    public async Task<Result> Handle(RestoreThongBaoCommand request, CancellationToken cancellationToken)
    {
