...
public class SearchLoaiThuTucTheoBaoCaoTongHopQueryHandler : IRequestHandler<SearchLoaiThuTucTheoBaoCaoTongHopQuery, PaginationResponse<LoaiThuTucDto>>
{
    private readonly string linhVucTableName = "Catalog.LoaiThuTucs";
    ...
    public SearchLoaiThuTucTheoBaoCaoTongHopQueryHandler(IDapperRepository dapperRepository)
    {
        _dapperRepository = dapperRepository;
        _tiepNhanHoSoTrucTuyenConstants = new TiepNhanHoSoTrucTuyenConstants();
    } 
    public async Task<PaginationResponse<LoaiThuTucDto>> Handle(SearchLoaiThuTucTheoBaoCaoTongHopQuery request, CancellationToken cancellationToken)
    {
        ...
        var sql = $"SELECT DISTINCT {linhVucTableName}.ID, {linhVucTableName}.Ten, {linhVucTableName}.Ma, {linhVucTableName}.MaNganh, " +
            ...
            $"ON {linhVucTableName}.Ma = {thuTucTableName}.MaLoaiThuTucChinh ";
