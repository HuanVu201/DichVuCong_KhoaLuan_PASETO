...
public class SearchNhomThuTucTheoBaoCaoTongHopQueryHandler : IRequestHandler<SearchNhomThuTucTheoBaoCaoTongHopQuery, PaginationResponse<NhomThuTucDto>>
{
    private readonly string linhVucTableName = "Catalog.NhomThuTucs";
    ...
    public SearchNhomThuTucTheoBaoCaoTongHopQueryHandler(IDapperRepository dapperRepository)
    {
        _dapperRepository = dapperRepository;
        _tiepNhanHoSoTrucTuyenConstants = new TiepNhanHoSoTrucTuyenConstants();
    } 
    public async Task<PaginationResponse<NhomThuTucDto>> Handle(SearchNhomThuTucTheoBaoCaoTongHopQuery request, CancellationToken cancellationToken)
    {
        ...
        var sql = $"SELECT DISTINCT {linhVucTableName}.ID, {linhVucTableName}.Ten, {linhVucTableName}.Ma, {linhVucTableName}.MaNganh, " +
            ...
            $"ON {linhVucTableName}.Ma = {thuTucTableName}.MaNhomThuTucChinh ";
