...
public class RestoreKenhTinCommandHandler : ICommandHandler<RestoreKenhTinCommand>
{
    private readonly IRepositoryWithEvents<KenhTin> _repositoryWithEvents;
    public RestoreKenhTinCommandHandler(IRepositoryWithEvents<KenhTin> repositoryWithEvents) => _repositoryWithEvents = repositoryWithEvents;
    public async Task<Result> Handle(RestoreKenhTinCommand request, CancellationToken cancellationToken)
    {
