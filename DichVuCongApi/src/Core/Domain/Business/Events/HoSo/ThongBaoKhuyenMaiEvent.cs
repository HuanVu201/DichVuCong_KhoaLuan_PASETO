...
public class ThongBaoKhuyenMaiEvent : HoSoEvent
{
    ...
    public ThongBaoKhuyenMaiEvent(Business.HoSoQLVB hoSo, int? thoiHanXuLy, string tenNguoiNhanHoSo, string tenDonVi, string tenTTHC, string tenDonViCha, string groupCatalog, string tenTinhThanh, bool khongCoNgayHenTra) : base(hoSo)
    {
