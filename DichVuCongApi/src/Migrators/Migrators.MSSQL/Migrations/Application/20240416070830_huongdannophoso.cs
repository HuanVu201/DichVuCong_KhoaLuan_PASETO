...
{
    /// <inheritdoc />
    public partial class huongdannophoso : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaHoSo = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuongDanNopHoSos", x => x.Id);
                });
        }
