...
export const NhomNguoiDungProvider = ({children}: IWithChildren) => {
    ...
    return <NhomNguoiDungContext.Provider value={{nhomNguoiDungId, setNhomNguoiDungId, nhomNguoiDungModalVisible, setNhomNguoiDungModalVisible, danhSachNguoiDungModalVisible, setDanhSachNguoiDungModalVisible}}>
        {children}
