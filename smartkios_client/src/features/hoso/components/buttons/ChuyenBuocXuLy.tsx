...
export interface ChuyenBuocXuLyProps extends BaseActionProps{
    actionName : string
}
// sử dụng comp này bọc ngoài do không thể sử dụng customhook, và các hook bth ở trong useMemo, useEffect
export const ChuyenBuocXuLyWrapper = (props: ChuyenBuocXuLyProps) => {
    
    return <ChuyenBuocXuLy {...props}></ChuyenBuocXuLy>
}

const ChuyenBuocXuLy = ({actionName, iconName, colorCode}: ChuyenBuocXuLyProps) => {
