...
export interface YeuCauBCCILayKetQuaModalProps extends BaseActionProps {
  actionName: string;
}
// sử dụng comp này bọc ngoài do không thể sử dụng customhook, và các hook bth ở trong useMemo, useEffect
export const YeuCauBCCILayKetQuaModalWrapper = (
  props: YeuCauBCCILayKetQuaModalProps
) => {
  return <YeuCauBCCILayKetQuaModal {...props}></YeuCauBCCILayKetQuaModal>;
};
