...
import { DangKyNhanKetQua } from "../themMoiHoSo/DangKyNhanKetQua"
...
const SuaHoSoModal = ({ setSearchParams }: { setSearchParams: React.Dispatch<React.SetStateAction<ISearchHoSo>> }) => {
    ...
    return <AntdModal confirmLoading={loading} visible={true} title="Chỉnh sửa hồ sơ" handlerCancel={handleCancel} fullsizeScrollable onOk={onOk} okText="Xác nhận">
            ...
            <Row gutter={8}>
                ...
                <>
                    <Col span={24}>
                        ...
                        <TepDinhKemSuaHoSo form={form} thanhPhanHoSos={thanhPhanHoSos}/>
                    </Col>
                    <AntdDivider />
                </>
            </Row>
