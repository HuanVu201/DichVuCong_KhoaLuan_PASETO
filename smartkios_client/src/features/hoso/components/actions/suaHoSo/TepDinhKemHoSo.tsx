...
export const TepDinhKemSuaHoSo = ({ form, thanhPhanHoSos}: { form: FormInstance<IHoSo>, thanhPhanHoSos: IThanhPhanHoSo[]| undefined}) => {
    ...
    const columns = useThanhPhanHoSoColumn({dataSource, setDataSource, form})
