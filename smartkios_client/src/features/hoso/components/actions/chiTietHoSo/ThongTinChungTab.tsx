...
export const ThongTinChungTab = ({form}: {form: FormInstance<IHoSo>}) => {
    ...
    return <Row gutter={8}>
        ...
        {hoSo?.eForm ? <Col span={24}>
            ...
            <ToKhaiDienTu form={hoSo.eForm} submission={hoSo?.eFormData ? { data: JSON.parse(hoSo.eFormData) } : undefined} antdForm={form} />
        </Col> : null}
        <AntdDivider />
        ...
        <>
            <Col span={24}>
                ...
                <ReadOnLyTepDinhKem form={form} thanhPhanHoSos={thanhPhanHoSos} />
            </Col>
            <AntdDivider />
        </>
    </Row>
