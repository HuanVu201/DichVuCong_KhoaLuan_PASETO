...
const DanhGiaHaiLongPortalModal = ({ maHoSoNguoiDungNhap, donViId, id }: { maHoSoNguoiDungNhap: string, donViId: string, id: any }) => {
    ...
    const handleCancel = async () => {
        ...
        buttonActionContext.setDanhGiaHaiLongModalVisible(false)
            ...
            <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
                ...
                <Col>
                    <Form.Item
                        ...
                        name="ngayTao"
                    >
                        <DatePicker format="DD/MM/YYYY" disabled defaultValue={moment() as any} />
                    </Form.Item>
                </Col>
            </div>
            <div>
                        ...
                        <div style={{ marginBottom: '35px', textAlign: 'justify' }}>
                            ...
                            >
                                <Radio.Group name="traLoi1" style={{ display: 'flex', flexDirection: 'column' }} defaultValue={defaultValue1} disabled>
                                    ...
                                    <Radio value="1"><span style={{ fontSize: '15px' }}>{item.chiso1.cauTraLoi.b}</span></Radio>
                        ...
                        <div style={{ marginBottom: '35px', textAlign: 'justify' }}>
                            ...
                            >
                                <Radio.Group name="traLoi2" style={{ display: 'flex', flexDirection: 'column' }} defaultValue={defaultValue1} disabled>
                                    ...
                                    <Radio value="1"><span style={{ fontSize: '15px' }}>{item.chiso2.cauTraLoi.b}</span></Radio>
                        ...
                        <div style={{ marginBottom: '35px', textAlign: 'justify' }}>
                            ...
                            >
                                <Radio.Group name="traLoi3" style={{ display: 'flex', flexDirection: 'column' }} defaultValue="2">
                                    ...
                                    <Radio value="1"><span style={{ fontSize: '15px' }}>{item.chiso3.cauTraLoi.b}</span></Radio>
                        ...
                        <div style={{ marginBottom: '35px', textAlign: 'justify' }}>
                            ...
                            >
                                <Radio.Group name="traLoi4" style={{ display: 'flex', flexDirection: 'column' }} defaultValue="2">
                                    ...
                                    <Radio value="1"><span style={{ fontSize: '15px' }}>{item.chiso4.cauTraLoi.b}</span></Radio>
                        ...
                        <div style={{ marginBottom: '35px', textAlign: 'justify' }}>
                            ...
                            >
                                <Radio.Group name="traLoi6" style={{ display: 'flex', flexDirection: 'column' }} defaultValue="2">
                                    ...
                                    <Radio value="1"><span style={{ fontSize: '15px' }}>{item.chiso6.cauTraLoi.b}</span></Radio>
                        ...
                        <div style={{ marginBottom: '35px', textAlign: 'justify' }}>
                            ...
                            >
                                <Radio.Group name="traLoi7" style={{ display: 'flex', flexDirection: 'column' }} defaultValue="2">
                                    ...
                                    <Radio value="1"><span style={{ fontSize: '15px' }}>{item.chiso7.cauTraLoi.b}</span></Radio>
