...
import { AddPhieuKhaoSat, DeletePhieuKhaoSat, GetBaoCao1, GetByMHS, GetPhieuKhaoSat, SearchBaoCao01, SearchPhieuKhaoSat, SearchPublicPhieuKhaoSat, UpdatePhieuKhaoSat } from "./action";
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(AddPhieuKhaoSat.fulfilled, () => {
                toast.success("Cán bộ đánh giá thành công")
            })
            .addCase(AddPhieuKhaoSat.rejected, (_, action) => {
                toast.error(action.error.message)
            })
            .addCase(UpdatePhieuKhaoSat.fulfilled, () => {
                toast.success("Công dân đánh giá thành công")
            })
            .addCase(UpdatePhieuKhaoSat.rejected, (_, action) => {
                toast.error("Công dân đánh giá thất bại")
            })
