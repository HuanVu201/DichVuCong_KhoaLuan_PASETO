...
export const ThanhPhanChungThuc = ({form, thanhPhanHoSos, soChungThucs}: {soChungThucs: ISoChungThuc[]; form: FormInstance<any>; thanhPhanHoSos: IThanhPhanHoSo[] | undefined}) => {
