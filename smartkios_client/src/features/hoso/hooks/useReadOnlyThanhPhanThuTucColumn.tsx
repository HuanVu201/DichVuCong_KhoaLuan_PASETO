...
export const useReadOnlyThanhPhanThuTucColumn = ({dataSource}: {dataSource: IThanhPhanHoSoWithSoHoa[]}) => {
    ...
    const columns = useMemo(() : ColumnsType<IThanhPhanHoSoWithSoHoa> => {
        return [
            ...
            },
            {
                ...
                key: "dinhKem",
                render: (_, record, idx) => {
                   return hoSo ? <UploadTable hideUpload={true} dinhKem={record.dinhKem} folderName={hoSo.maHoSo} colDinhKemName={"dinhKem"} rowNumber={idx} /> : null
                }
            },
        ]
    }, [dataSource, hoSo])
