...
export const FORMAT_SOGIAYTO_LABEL = {
    "Công dân" : "Số căn cước công dân",
    "Doanh nghiệp" : "Mã số thuế",
    "Tổ chức" : "Mã định danh",
    "Khác" : "Mã định danh",
    "Cơ quan nhà nước" : "Số căn cước công dân",
}
...
export const TRANGTHAISOHOA: Record<"Chưa số hóa" | "Được số hóa" | "Tái sử dụng" | "Tái sử dụng từ kết quả hồ sơ khác",TRANGTHAISOHOA_CONST_VALUE> = {
    "Chưa số hóa": "0",
    "Được số hóa":"1",
    "Tái sử dụng": "2",
...
export const TRANGTHAISOHOA_VALUE: Record<TRANGTHAISOHOA_CONST_VALUE, TRANGTHAISOHOA_TYPE> = {
    "0" : "Chưa số hóa",
    "1" : "Được số hóa",
    "2" : "Tái sử dụng",
