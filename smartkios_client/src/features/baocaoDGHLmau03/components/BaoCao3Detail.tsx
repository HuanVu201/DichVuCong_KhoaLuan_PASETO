...
import { GetDanhGiaCoQuan, UpdateDanhGiaCoQuan } from "@/features/danhgiacoquan/redux/action"
...
export const BaoCao3Detail = () => {
    ...
    const onFinish = async () => {
        ...
        dispatch(UpdateDanhGiaCoQuan({ id: DanhGiaCoQuanContext.DanhGiaCoQuanId, data: formData }))
