...
import { DatLaiNgayHenTra, DatLaiQuyTrinhXuLy,AdminUpdateHoSo, AdminGetHoSo, AdminGetYeuCauThanhToan, AdminUpdateYeuCauThanhToan } from "./action";
import { IAdminHoSo } from "../models/AdminHoSoDto";
import { IAdminYeuCauThanhToan } from "../models/AdminYeuCauThanhToanDto";

export interface IHoSoState extends ExtendedState<IAdminHoSo, {hoSoNguoiDung: {
