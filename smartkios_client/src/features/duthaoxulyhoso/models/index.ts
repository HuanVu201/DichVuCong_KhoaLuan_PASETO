...
export interface ISearchDuThaoXuLyHoSo extends IPickSearch<IDuThaoXuLyHoSo, "maHoSo">, 
        Pick<ISearchHoSo, "maLinhVucChinh" |"tiepNhanFrom" |"tiepNhanTo" |"henTraFrom" |"henTraTo" |"maTrangThai" |"searchKeys" >{
            loaiDuThao?: string;
            trangThaiDuThao?: string;
}


export interface ISearchDuThaoXuLyHoSoResponse extends 
