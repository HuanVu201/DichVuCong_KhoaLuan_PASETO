            ...
            },
            {
                ...
                render: (_, record) => {
                    return <div style={{ display: "flex", alignSelf: "flex-start", flexDirection: "column" }}>
                        ...
                        {record.soDienThoaiChuHoSo ? <div style={{ fontWeight: '500', display: "flex", alignItems: "center" }} role='button' onClick={() => window.open(`tel:+${record.soDienThoaiChuHoSo}`)}> <PhoneOutlined title="Số điện thoại" style={{ marginRight: 3 }} /> <span>{record.soDienThoaiChuHoSo}</span></div> : null}
