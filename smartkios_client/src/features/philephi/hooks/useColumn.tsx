...
export const useColumn = (pagination: IBasePagination, setSearchParams: React.Dispatch<React.SetStateAction<ISearchPhiLePhi>> ) => {
                ...
                render: (_, record) => (
                    <Space direction="horizontal">
                        ...
                        <Popconfirm
                            title='Xoá?'
                            onConfirm={async () => {
                                await dispatch(DeletePhiLePhi({ id: record.id, forceDelete: false })).unwrap()
