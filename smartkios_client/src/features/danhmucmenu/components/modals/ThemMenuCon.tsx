...
export const ThemMenuCon = ({ handlerClose, visible, folderId, }: { handlerClose: () => void, visible: boolean, folderId: string }) => {
    ...
    return (
        <AntdModal title="Thêm mới Menu con" handlerCancel={handleCancel} visible={visible} onOk={onOk} okText="Xác nhận" cancelText="Đóng"
            // xóa modal khỏi dom khi đóng modal thay vì ẩn (nên xóa khi xử lý nhiều form trên 1 trang)
            destroyOnClose>
            <Form name='AddSubMenu' layout="vertical" form={form} requiredMark={true} initialValues={{parentId: folderId, active: true}}>
