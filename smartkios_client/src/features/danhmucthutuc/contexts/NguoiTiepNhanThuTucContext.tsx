...
export const NguoiTiepNhanThuTucProvider = ({ children }: IWithChildren) => {
    ...
    return <NguoiTiepNhanThuTucContext.Provider value={{ NguoiTiepNhanThuTucId, setNguoiTiepNhanThuTucId, NguoiTiepNhanThuTucModalVisible, setNguoiTiepNhanThuTucModalVisible, setAddCanBoTiepNhanModalVisible, AddCanBoTiepNhanModalVisible }}>
        {children}
