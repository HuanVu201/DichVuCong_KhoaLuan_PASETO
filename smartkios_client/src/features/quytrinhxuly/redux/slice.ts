...
const Slice = createGenericSlice({
    ...
    extraReducers:(builder) => {
        builder
            ...
            .addMatcher(isRejectedWithValue(SearchQuyTrinhXuLy, GetQuyTrinhXuLy, AddQuyTrinhXuLy, UpdateQuyTrinhXuLy, DeleteQuyTrinhXuLy,DuplicateQuyTrinhXuLy), (state, action) => {
