...
function ContentTraCuuKiosk({ form }: { form: FormInstance<ReCapChaProps> }) {
    ...
    // if (traCuuContext.hoSos && traCuuContext.hoSos.length > 1) {
    //     return (
    //         <div className='contentTraCuu' key={"1"}>
    ...
    //                         <thead>
    //                             <tr>
    //                                 <th className='titleTable'>Chủ hồ sơ</th>
    //                                 <th className='titleTable'>Tên thủ tục</th>
    //                                 <th className='titleTable'>Ngày tiếp nhận</th>
    //                                 <th className='titleTable'>Ngày hẹn trả</th>
    //                                 <th> </th>
    //                             </tr>
    //                         </thead>
    //                         <tbody>
    //                             {traCuuContext.hoSos?.map((hoSo, index) => (<>
    //                                 <tr key={index}>
    //                                     <td className='dataTable'>{hoSo.chuHoSo}</td>
    //                                     <td className='dataTable'>{hoSo.tenTTHC}</td>
    //                                     <td className='dataTable'>{hoSo.ngayTiepNhan ? dayjs(hoSo.ngayTiepNhan).format(FORMAT_DATE) : ""}</td>
    //                                     <td className='dataTable'>{hoSo.ngayHenTra ? dayjs(hoSo.ngayHenTra).format(FORMAT_DATE) : ""}</td>
    //                                     <td ><AntdButton onClick={() => onShowDetailHoSo(hoSo.maHoSo)}>Chi tiết</AntdButton></td>
    //                                 </tr>
    //                             </>))}
    //                         </tbody>
    //                     </table>
    ...
    //     )
    // } else if (traCuuContext.hoSos && traCuuContext.hoSos.length == 1) {
    //     const hoSo = traCuuContext.hoSos[0]
    //     return (
...
export default ContentTraCuuKiosk;