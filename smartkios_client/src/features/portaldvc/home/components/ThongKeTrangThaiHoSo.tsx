  ...
  return (
    <div className="thongKe-home" >
      <div className="containerThongKeTrangThai">
        <div className="thongKeTrangThaiBlock" style={{display: 'flex', gap: 32}}>
            ...
            return (
              <>
                <div className="thongKeItem" key={index} style={{flex: 1}}>
                  ...
                  <h3 >{key === "daHoanThanhDungHan" ? tongSo.toFixed(2) + "%" : getCurrency(hoSo[key], ".")}</h3>
                  <span>{data?.type}</span>
                </div>
              </>
            );
