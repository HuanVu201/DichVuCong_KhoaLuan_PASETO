...
export const CardThuTucPortal = ({ thuTuc }: { thuTuc: IThuTuc }) => {
  ...
  return (
    <Link className="text-dark" to={Service.primaryRoutes.portaldvc.nopHoSoTrucTuyen +
            "?maTTHC=" + thuTuc.maTTHC}>
      <ThuTucItem thuTuc={thuTuc} />
    </Link>
  );
};
