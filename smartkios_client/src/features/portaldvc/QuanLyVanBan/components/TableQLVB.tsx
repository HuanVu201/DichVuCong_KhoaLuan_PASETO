...
const PossitionPage: React.FC = () => {
    ...
    const onChange: PaginationProps['onChange'] = (page) => {
        setCurrent(page);
        dispatch(SearchQuanLyVanBan({ pageSize: 10, pageNumber: page }) as any)
    };
...
export const TableQLVB = () => {
    ...
    useEffect(() => {
        dispatch(SearchQuanLyVanBan({ pageNumber: 1, pageSize: 10, congKhai: true }))
    }, [])
    ...
    return (
        <div>
                    ...
                    <div className="d-flex ">
                        <div style={{ marginRight: "10px" }}>
                            <Form.Item
                                name="maLinhVuc"
                            >
                                <AntdSelect style={{ width: '350px' }} placeholder='Chọn lĩnh vực' generateOptions={{ model: LinhVucs, label: 'ten', value: 'ma' }} />
                            </Form.Item>
                        </div>
                        <div style={{ marginRight: '20px' }}>
                            <Form.Item
                                name="tuKhoa"
                            >
                                <Input style={{ width: '200px' }} placeholder='Nhập từ khóa' />
                            </Form.Item>
                        </div>
                    </div>
                    <div>
                        <Form.Item style={{ marginBottom: 0 }}>
                            <AntdButton style={{ backgroundColor: '#ce7a58', float: 'right' }} htmlType="submit">
                                Tìm kiếm
                            </AntdButton>
                        </Form.Item>
                    </div>
            ...
            {QuanLyVanBan ?
                <div>
                    <div style={{ color: 'white', backgroundColor: '#ce7a58', borderColor: '#bce8f1', padding: '10px 15px', textAlign: 'center', borderTopLeftRadius: '3px', borderTopRightRadius: '3px', fontWeight: 'bold' }}>
                ...
                <div className='mb-5 table'>
                    <table style={{
                        verticalAlign: "middle", borderCollapse: "collapse", width: "100%", alignItems: 'center', textAlign: "center", fontSize: "16px", fontFamily: "'Times New Roman', Times, serif"
