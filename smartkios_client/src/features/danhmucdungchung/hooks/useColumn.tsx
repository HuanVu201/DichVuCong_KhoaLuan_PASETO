...
export const useColumn = (pagination: IBasePagination) => {
    ...
    const columns = useMemo((): ColumnsType<IDanhMucChung> => {
        return [
            ...
            {
                title: searchRouterParams.get("type") == 'quoc-tich' ? "Mã quốc tịch" : searchRouterParams.get("type") == 'dan-toc' ? "Mã dân tộc" : searchRouterParams.get("type") == 'hoc-van' ? "Mã học vấn" : searchRouterParams.get("type") == 'chuc-vu' ? "Mã chức vụ" : searchRouterParams.get("type") == 'hoc-vi' ? "Mã học vị" : searchRouterParams.get("type") == 'lanh-dao' ? "Mã lãnh đạo" : searchRouterParams.get("type") == 'nghe-nghiep' ? "Mã nghề nghiệp" : searchRouterParams.get("type") == 'ton-giao' ? "Mã tôn giáo" : searchRouterParams.get("type") == 'ngay-nghi' ? "Ngày nghỉ" : '',
                key: "type",
                dataIndex: "code",
            },
            {
                title: searchRouterParams.get("type") == 'quoc-tich' ? "Tên quốc tịch" : searchRouterParams.get("type") == 'dan-toc' ? "Tên dân tộc" : searchRouterParams.get("type") == 'hoc-van' ? "Tên học vấn" : searchRouterParams.get("type") == 'chuc-vu' ? "Tên chức vụ" : searchRouterParams.get("type") == 'hoc-vi' ? "Tên học vị" : searchRouterParams.get("type") == 'lanh-dao' ? "Tên lãnh đạo" : searchRouterParams.get("type") == 'nghe-nghiep' ? "Tên nghề nghiệp" : searchRouterParams.get("type") == 'ton-giao' ? "Tên tôn giáo" : searchRouterParams.get("type") == 'ngay-nghi' ? "Ngày nghỉ" : '',
                key: "type",
