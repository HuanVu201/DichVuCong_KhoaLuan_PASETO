...
export const BoSungHoSoSearch = ({ setSearchParams }: { setSearchParams: React.Dispatch<React.SetStateAction<ISearchHoSo>> }) => {
  ...
  return (
    <CollapseContent
      extraButtons={[<AntdButton onClick={() => {boSungHoSoContext.setDetailBoSungHoSoModalVisible(true)}}>Thêm mới</AntdButton>]}
    >
