...
import { useThongKeHoSoTrucTuyenCapTinhContext, ThongKeHoSoTrucTuyenCapTinhProvider } from "../context/ThongKeHoSoTrucTuyenContext";
import {
  SearchOutlined,
  PrinterOutlined,
  DownOutlined,
...
const ThongKeHoSoTrucTuyenCapTinh = () => {
  ...
  useEffect(() => {
    (async () => {
      dispatch(SearchTkHoSoTrucTuyenCapTinh(thongKeHoSoContext.search));
    })();
  }, [thongKeHoSoContext.search]);
  ...
  const thamChieuLaMa = ["I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X"]
  let dataHtmlForPdf = ''
  ...
  thongKeDatas?.forEach((item: any, index) => {
    ...
    dataHtmlForExecl += "<tr>" +
      ...
      "</tr >" +
      "<tr>" +
      "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; text-align: center; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >1</td>" +
      "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; text-align: left; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >" +
      "DVC trực tuyến một phần" +
      "</td>" +
      "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; text-align: center; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >" +
      ...
      "</tr>" +
      "<tr>" +
      "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; text-align: center; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >2</td>" +
      "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; text-align: left; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >" +
      "DVC trực tuyến toàn trình" +
      "</td>" +
      "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; text-align: center; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >" +
  ...
  return (
    <div className="thongKeSwapper">
      ...
      <div id="ContainerSwapper">
        <table id="" style={{ verticalAlign: 'middle', borderCollapse: 'collapse', width: '100%', textAlign: 'center', margin: '10px 0', fontSize: '17px', fontFamily: "'Times New Roman', Times, serif" }}>
          {/* <thead> */}
          <tr>
            <td colSpan={9} style={{ verticalAlign: 'middle', padding: '5px', fontSize: '19px' }}>
              <strong>PHỤ LỤC 1</strong><br />
              <strong>BẢNG THỐNG KÊ TIẾP NHẬN HỒ SƠ TRỰC TUYẾN TRÊN ĐỊA BÀN TỈNH</strong><br />
              <strong className="filterDate" dangerouslySetInnerHTML={{ __html: dateToDate || "" }} />
            </td>
          </tr>
          <tr>
            <td rowSpan={2} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333', width: '3%' }}>
              <strong>TT</strong>
            </td>
            <td rowSpan={2} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333', width: '20%' }}>
              <strong>Đơn vị</strong>
            </td>
            <td rowSpan={2} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333', width: '11%' }}>
            ...
            <td rowSpan={2} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333', width: '11%' }}>
              <strong>Tỷ lệ hồ sơ nộp trực tuyến DVC trực tuyến toàn trình</strong>
            </td>
          ...
          <tr>
            <td style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333', width: '11%' }}>
      ...
      <table id="tableToExcel" style={{ display: 'none', verticalAlign: 'middle', borderCollapse: 'collapse', width: '100%', textAlign: 'center', margin: '10px 0', fontFamily: "'Times New Roman', Times, serif" }}>
        <thead>
          <tr>
            <td colSpan={9} style={{ verticalAlign: 'middle', padding: '5px', textAlign: 'center', fontFamily: "'Times New Roman', Times, serif", fontSize: '24px' }}>
              <strong>PHỤ LỤC 1</strong><br />
              <strong>BẢNG THỐNG KÊ TIẾP NHẬN HỒ SƠ TRỰC TUYẾN TRÊN ĐỊA BÀN TỈNH</strong><br />
              <strong className="filterDate" dangerouslySetInnerHTML={{ __html: dateToDate || "" }} />
            </td>
          ...
          <tr>
            ...
            <td colSpan={3} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333', fontFamily: "'Times New Roman', Times, serif", fontSize: '22px' }}>
              <strong>Trong đó</strong>
            </td>
            <td rowSpan={2} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333', textAlign: 'center', fontFamily: "'Times New Roman', Times, serif", fontSize: '22px' }}>
              <strong>Tỷ lệ hồ sơ nộp trực tuyến</strong>
        ...
        <tbody id="data" dangerouslySetInnerHTML={{ __html: dataHtmlForExecl || "Không có dữ liệu!" }} />
