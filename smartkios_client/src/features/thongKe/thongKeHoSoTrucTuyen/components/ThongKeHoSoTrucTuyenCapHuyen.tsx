...
import { useThongKeHoSoTrucTuyenCapHuyenContext, ThongKeHoSoTrucTuyenCapHuyenProvider } from "../context/ThongKeHoSoTrucTuyenContext";
import {
    SearchOutlined,
    PrinterOutlined,
    DownOutlined,
...
const items: MenuProps['items'] = [
    {
        label: <button onClick={() => { downloadPhieuWord('Bảng thống kê tiếp nhận hồ sơ trực tuyến của UBND cấp huyện') }} style={{ border: 'none', background: 'inherit' }}>
    ...
    },
    {
        label: <button style={{ border: 'none', background: 'inherit' }}
            onClick={() => downloadPhieuExcel('Bảng thống kê tiếp nhận hồ sơ trực tuyến của UBND cấp huyện')}>
...
const ThongKeHoSoTrucTuyenCapHuyen = () => {
    ...
    useEffect(() => {
        (async () => {
            dispatch(SearchCoCauToChuc({ type: 'don-vi', cataLog: 'quan-huyen', pageSize: 200, pageNumber: 1 }));
        })();
    }, []);
    ...
    useEffect(() => {
        (async () => {
            dispatch(SearchTkHoSoTrucTuyenCapHuyen(thongKeHoSoContext.search));
        })();
    }, [thongKeHoSoContext.search]);
    ...
    return (
        <div className="thongKeSwapper">
            <div className="headerThongKe">
                <div className="title">
                    <h6>BẢNG THỐNG KÊ TIẾP NHẬN HỒ SƠ TRỰC TUYẾN CỦA CỦA UBND CẤP HUYỆN</h6>
                </div>
                ...
                <table id="table" style={{ verticalAlign: 'middle', borderCollapse: 'collapse', width: '100%', textAlign: 'center', margin: '10px 0', fontSize: '17px', fontFamily: "'Times New Roman', Times, serif" }}>
                    ...
                    <tr>
                        <td colSpan={10} style={{ verticalAlign: 'middle', padding: '5px', fontSize: '19px' }}>
                            <strong>PHỤ LỤC 3</strong><br />
                            <strong>BẢNG THỐNG KÊ TIẾP NHẬN HỒ SƠ TRỰC TUYẾN CỦA UBND CẤP HUYỆN</strong><br />
                    ...
                    <tr>
                        ...
                        <td rowSpan={2} colSpan={4} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #333' }}>
                            ...
                            <span>(Tỷ lệ nộp hồ sơ trực tuyến: 87%; Tỷ lệ nộp hồ sơ trực tuyến toàn trình: 80%)</span>
                        </td>
                    </tr>
                    <tr>
