...
const items: MenuProps["items"] = [
  // {
  //     label: <button onClick={() => { downloadPhieuWord('Theo dõi chỉ tiêu tiến độ giải quyết các đơn vị - theo quyết định số 766/QĐ-TTg ngày 23/06/2022') }} style={{ border: 'none', background: 'inherit' }}>
  ...
  // },
  // {
  //     label: <button onClick={() => downloadPhieuPdf('Theo dõi chỉ tiêu tiến độ giải quyết các đơn vị - theo quyết định số 766/QĐ-TTg ngày 23/06/2022')} style={{ border: 'none', background: 'inherit' }}>
  ...
  thongKeDatas?.forEach((item: any, index) => {
    if (item.catalog === "so-ban-nganh") {
      ...
      dataHtmlForExcel +=
        ...
        item.tongCoNghiaVuTaiChinh +
        "</td>" +
        "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; color: red; text-align: center; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >" +
        item.daTTTTQuaDvcqg +
        "</td>" +
        "<td style='vertical-align: middle; padding: 5px; border: 1px solid #333; text-align: center; font-size: 22px; font-family: &quot;Times New Roman&quot;, Times, serif;' >" +
        (item?.daTTTTQuaDvcqg / item?.tongCoNghiaVuTaiChinh > 0
    ...
    <div className="thongKeSwapper">
      ...
      <div id="ContainerSwapper">
        ...
        >
          ...
          <tr>
            ...
            >
              <strong>
                THEO DÕI CHỈ TIÊU TIẾN ĐỘ GIẢI QUYẾT CÁC ĐƠN VỊ - THEO QUYẾT
      ...
      >
        <tr>
          ...
          >
            <strong>
              THEO DÕI CHỈ TIÊU TIẾN ĐỘ GIẢI QUYẾT CÁC ĐƠN VỊ - THEO QUYẾT ĐỊNH
