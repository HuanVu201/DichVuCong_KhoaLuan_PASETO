...
class LogCSDLDanCuDoanhNghiepService extends Service.BaseApi implements Service.ICrud<ILogCSDLDanCuDoanhNghiep>{
    ...
    Search(_params: IPickSearch<ILogCSDLDanCuDoanhNghiep, "donViId" | "thoiGian" | "loai">): AxiosResponseWrapper<IPaginationResponse<ILogCSDLDanCuDoanhNghiep[]>> {
        return axiosInstance.get(this._urlSuffix, { params: _params })
    }
    Statistic(_params: IPickSearch<IStatisticLogCSDLDanCuDoanhNghiep,  "thoiGian" >): AxiosResponseWrapper<IPaginationResponse<IStatisticLogCSDLDanCuDoanhNghiep[]>> {
        return axiosInstance.get(this._urlSuffix + "/statistic", { params: _params })
    }
