...
//     const modalContext = useScreenActionContext()
...
//     useEffect(() => {
//         if(modalContext.showModalAddAction.id){
//             dispatch(GetUserById(modalContext.showModalAddAction.id))
//         }
//     },[modalContext.showModalAddAction.id])
