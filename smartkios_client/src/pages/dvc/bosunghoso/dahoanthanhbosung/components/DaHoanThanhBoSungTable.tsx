...
const DaHoanThanhBoSungTable = () => {
    ...
    const [searchParams, setSearchParams] = useState<ISearchHoSo>({ pageNumber: 1, pageSize: 10, reFetch: true, trangThaiBoSung:"Hoàn thành bổ sung", maTrangThai:"10", groupCode: user?.officeCode})
    ...
    return (
        <LazyActions setSearchParams={setSearchParams}>
            <AntdSpace direction="vertical" style={{width:"100%"}}>
                ...
                {searchParams.nguoiNhanHoSo ? <AntdTable
                    columns={columns}
                    dataSource={hoSos}
                    pagination={{
                        total: count
