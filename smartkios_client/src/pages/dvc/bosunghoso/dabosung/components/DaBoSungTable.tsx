...
import { DaBoSungProvider, useDaBoSungContext } from "../contexts/DaBoSungContext"
...
const DaBoSungTable = () => {
    ...
    const {btnElememts} = useButtonActions({maScreen: screenType["da-bo-sung-ho-so"]})
    const [searchParams, setSearchParams] = useState<ISearchHoSo>({ pageNumber: 1, pageSize: 10, reFetch: true, maTrangThai: "5", groupCode: user?.officeCode, trangThaiBoSung : "Công dân đã gửi bổ sung"})
...
const HoSoTableWrapper = () => (<DaBoSungProvider>
