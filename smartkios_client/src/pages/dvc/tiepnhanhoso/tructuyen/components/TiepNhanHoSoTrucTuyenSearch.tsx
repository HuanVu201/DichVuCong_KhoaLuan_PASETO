...
export const TiepNhanHoSoTrucTuyenSearch = ({ setSearchParams, resetSearchParams }: { setSearchParams: React.Dispatch<React.SetStateAction<ISearchHoSo>>; resetSearchParams: () => void }) => {
        ...
        <Row gutter={[8, 8]}>
          ...
          <Col md={12} span={24}>
            <Form.Item label="Tiếp nhận ngày" name="tiepNhanFrom">
              <DatePicker style={{ width: '100%' }} format={FORMAT_DATE} showTime />
            </Form.Item>
          </Col>
          <Col md={12} span={24}>
        ...
        <Form.Item>
          <Row justify="space-around">
            <Space size="large">
              ...
              <AntdButton type="default" onClick={reset}>
                Tải lại
              </AntdButton>
            </Space>
          </Row>
