...
const HoSoQuaHanTable = () => {
    ...
    const [searchParams, setSearchParams] = useState<ISearchHoSo>({ pageNumber: 1, pageSize: 10, reFetch: true, maTrangThai: "4", henTraTo: dayjs().format("YYYY-MM-DD"), nguoiNhanHoSo: user?.id})
