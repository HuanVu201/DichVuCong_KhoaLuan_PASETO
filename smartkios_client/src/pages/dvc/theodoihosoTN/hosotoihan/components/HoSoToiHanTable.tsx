...
const HoSoToiHanTable = () => {
    ...
    const [searchParams, setSearchParams] = useState<ISearchHoSo>({ pageNumber: 1, pageSize: 10, reFetch: true, maTrangThai: "4", henTraFrom: dayjs().format("YYYY-MM-DD"), nguoiNhanHoSo: user?.id })
