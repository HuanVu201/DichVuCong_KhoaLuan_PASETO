...
const DaTraTable = () => {
    ...
    const {btnElememts} = useButtonActions({maScreen: screenType["da-tra-ho-so"]})
    const [searchParams, setSearchParams] = useState<ISearchHoSo>({ pageNumber: 1, pageSize: 10, reFetch: true, maTrangThai: "10", groupCode: user?.officeCode})
