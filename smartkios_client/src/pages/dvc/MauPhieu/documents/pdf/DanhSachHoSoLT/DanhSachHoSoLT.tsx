                ...
                <div style={{ margin: 'auto', }}>
                    <table
                        ...
                        <tr>
                            ...
                            <td id="ChuHoSo" style={{ border: '1px solid #333', padding: '5px', }}>
                                3
                            </td>
                            <td id="TenHoSo" style={{ border: '1px solid #333', padding: '5px', }}>
                                4
                            </td>
                            <td id="DonViGui" style={{ border: '1px solid #333', padding: '5px', }}>
                                5
                            </td>
