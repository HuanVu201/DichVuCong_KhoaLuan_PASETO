...
export const BaoCaoXuLyLinhVuc = () => {
                    ...
                    <div style={{ marginBottom: '8px', }}>
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    <div style={{ paddingLeft: '15px', }}>- Tiếp nhận trong tháng</div>
                                </td>
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    ...
                                </td>
                            ...
                            <tr>
                                ...
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    <div style={{ paddingLeft: '15px', }}>- Từ tháng trước chuyển sang </div>
                                </td>
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    ...
                                </td>
                            ...
                            <tr>
                                ...
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    <div style={{ paddingLeft: '15px', }}>- Trả kết quả đúng hạn </div>
                                </td>
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    ...
                                </td>
                            ...
                            <tr>
                                ...
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    <div style={{ paddingLeft: '15px', }}>- Trả kết quả quá hạn</div>
                                </td>
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    ...
                                </td>
                            ...
                            <tr>
                                ...
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    <div style={{ paddingLeft: '15px', }}>- Chưa xử lý xong</div>
                                </td>
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    ...
                                </td>
                            ...
                            <tr>
                                ...
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    <div style={{ paddingLeft: '15px', }}>- Trả lại</div>
                                </td>
                                <td style={{ border: '1px solid #333', padding: '5px', }}>
                                    ...
                                </td>
