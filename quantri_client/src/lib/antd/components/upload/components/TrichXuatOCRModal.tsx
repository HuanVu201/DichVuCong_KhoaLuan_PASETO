...
const TrichXuatOCRModal = ({ dinhKemSoHoa, handleClose, dinhKem, soHoaData, closePickKetQuaModal }: { closePickKetQuaModal?: SoHoaKetQuaProps["closePickKetQuaModal"];soHoaData: SoHoaData; dinhKem: string | undefined; dinhKemSoHoa: string | undefined; handleClose: () => void }) => {
            ...
            if (dinhKemSoHoa && soHoaData.maOcr && soHoaData.ketQuaThuTucId) {
                ...
                if (res.data.succeeded) {
                    ...
                    soHoaRef.current?.setData({
                        ...
                        thoiHanHieuLuc: soHoaData.thoiHanMacDinh && soHoaData.loaiThoiHan ? dayjs(ngayBanHanh).add(soHoaData.thoiHanMacDinh, soHoaData.loaiThoiHan as any) : undefined,
                    })
                }
            }
            // }
