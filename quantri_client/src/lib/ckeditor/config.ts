...
import { Table, TableToolbar, TableProperties, TablePropertiesEditing, TableEditing } from '@ckeditor/ckeditor5-table';
...
export const editorConfiguration = {
    plugins: [HtmlEmbed, GeneralHtmlSupport, Essentials, Heading, Bold, Code, Strikethrough, Subscript, Superscript, Underline, Italic, Paragraph, Link, List,
        Table, TableToolbar, TableProperties, TablePropertiesEditing, TableEditing, MediaEmbed,
