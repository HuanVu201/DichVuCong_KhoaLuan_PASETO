...
const DSTaiLieuHDSDCanBoLazy = lazy(() => import("../portaldvc_admin/DSTaiLieuHDSDCanBo"))
...
const ThongKeKhoTaiLieuDienTuLazy = lazy(() => import("../../features/portaldvc_admin/ThongKeKhoTaiLieuDienTu/components/ThongKe/ThongKeKhoTaiLieuSwapper"))
...
export const bannerRoutes = (): RouteObject[] => {
    ...
    return [
        ...
        {
            path: primaryRoutes.portaldvc_admin.thongKeKhoTaiLieuDienTu,
            element: <ThongKeKhoTaiLieuDienTuLazy />
        },
