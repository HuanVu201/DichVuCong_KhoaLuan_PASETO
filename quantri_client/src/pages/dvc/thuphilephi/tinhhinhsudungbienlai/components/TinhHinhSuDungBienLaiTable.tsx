...
import { TinhHinhSuDungBienLaiProvider } from "../contexts/TinhHinhSuDungBienLaiContext"
...
const TinhHinhSuDungBienLaiTable = () => {
    ...
    const [searchParams, setSearchParams] = useState<ISearchHoSo>({ pageNumber: 1, pageSize: 50, reFetch: true, groupCode: user?.id})
    ...
    const { columns } = useHoSoColumn({ pageNumber: searchParams.pageNumber, pageSize: searchParams.pageSize }, items, 'tinh-hinh-su-dung-bien-lai-thu-phi')
    const rowSelection = {
