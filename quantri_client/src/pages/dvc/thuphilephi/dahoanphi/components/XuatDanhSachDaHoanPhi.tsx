...
export const XuatDanhSachHoanPhi = ({
  yeucauthanhtoans,
}: {
      ...
      >
        ...
        <thead>
          <tr>
            ...
            >
              <strong>Người nhận hoàn phí</strong>
            </td>
            <td
              style={{
                verticalAlign: "middle",
            ...
            return (
              <tr>
                ...
                >
                  <div>
                    <div style={{ fontWeight: "500" }}>
                      {item.tenTaiKhoanHoanPhi
                        ? `Họ và tên: ${item.tenTaiKhoanHoanPhi}`
                        : null}
                    </div>
                    <div style={{ fontWeight: "500" }}>
                      {item.tenNganHangHoanPhi
                        ? `Ngân hàng: ${item.tenNganHangHoanPhi}`
                        : null}
                    </div>
                    <div style={{ fontWeight: "500" }}>
                      {item.soTaiKhoanHoanPhi
                        ? `Số tài khoản: ${item.soTaiKhoanHoanPhi}`
                        : null}
                    </div>
                  </div>
                </td>
                ...
                >
                  <div>
                    <div style={{ fontWeight: "500" }}>{item.lyDoHoanPhi}</div>
                  </div>
                </td>
                <td
                  style={{
                ...
                >
                  <div>
                    {item.ngayHoanPhi
                      ? dayjs(item.ngayHoanPhi).format(FORMAT_DATE)
                      : ""}
                  </div>
                </td>
              </tr>
