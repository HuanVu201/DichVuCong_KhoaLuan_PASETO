...
export const XuatDanhSachDaThuPhi = ({
  yeucauthanhtoans,
}: {
      ...
      >
        ...
        <thead>
          <tr>
            ...
            >
              <strong>Ngày thu phí, lệ phí</strong>
            </td>
          </tr>
        </thead>
        <tbody>
          {yeucauthanhtoans?.map((item, index) => {
            return (
              <tr>
                ...
                >
                  <span>{item.hinhThucThanhToan == "chuyen-khoan" ? "Chuyển khoản" : 
                  item.hinhThucThanhToan  == "tien-mat" ? "Tiền mặt" : 
                  item.hinhThucThanhToan == "truc-tuyen" ? "Trực tuyến" : item.hinhThucThanhToan}</span>
                </td>
                <td
                  style={{
                    verticalAlign: "middle",
