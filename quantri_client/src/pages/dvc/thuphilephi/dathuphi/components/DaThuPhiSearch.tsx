...
export const DaThuPhiSearch = ({
  ...
  const KHONGCOBIENLAI_OPTIONS = [
    { label: "Có biên lai", value: false },
    { label: "Không có biên lai", value: true },
    ...
    <CollapseContent extraButtons={buttons}>
      ...
      >
        <Row gutter={[8, 0]}>
          ...
          <Col md={8} span={24}>
            <Form.Item label="Thông tin biên lai" name="khongCoBienLai">
              <AntdSelect
                allowClear
                showSearch
                filterOption={filterOptions}
                options={KHONGCOBIENLAI_OPTIONS as any}
              />
            </Form.Item>
          </Col>
          {/* <Col md={12} span={24}>
