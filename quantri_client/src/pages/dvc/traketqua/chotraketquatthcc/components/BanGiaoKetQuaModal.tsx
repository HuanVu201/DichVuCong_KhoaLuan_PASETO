...
import { PhieuBanGiaoKetQua } from "@/pages/dvc/MauPhieu/documents/pdf/PhieuBanGiaoKetQua/PhieuBanGiaoKetQua"
...
const PhieuBanGiaoKetQuaModalVisible = () => {
    ...
    const handlerCancel = () => {
        ...
        buttonActionContext.setBanGiaoKetQuaModalVisible(false)
    }
    ...
    const xuatLaiPhieuAction = () => {
        if (buttonActionContext.banGiaoKetQuaModalVisible) {
    ...
    return <AntdModal okText="Tải phiếu" visible={true} title={"Phiếu bàn giao kết quả"} fullsizeScrollable handlerCancel={handlerCancel}
        footer={[
...
const PhieuBanGiaoKetQuaModal = () => (
    <XuLyHoSoProvider>
        <PhieuBanGiaoKetQuaModalVisible />
    </XuLyHoSoProvider>
);


export default PhieuBanGiaoKetQuaModal