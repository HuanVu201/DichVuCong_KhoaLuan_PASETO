...
export const dangKyQuaBuuDienOptions: SelectProps["options"] = [
  { label: "Có", value: true as any },
  { label: "Không", value: "false" },
];

export const ChoTraKetQuaTTHCCSearch = ({
  setSearchParams,
  resetSearchParams,
  extraElement,
  defaultFormValue,
  ...
  const onFinish = (values: ISearchHoSo) => {
    // if (!form.getFieldValue('groupCode')) {
        ...
        >
          <div className="search-form-content">
            <Row gutter={[16, 5]}>
              ...
              <Col md={5} span={24}>
                <Form.Item label="Công dân đăng ký bưu điện" name="nhanKetQuaBCCI">
                  <AntdSelect
                    options={dangKyQuaBuuDienOptions}
                    showSearch
                    allowClear
