...
export const useChoTraTheoNguoiTiepNhanColumn = (
  pagination: IBasePagination,
  items: HoSoTableActions[],
  maScreen?: string | undefined
) => {
          ...
          return (
            <>
              ...
              >
                ...
                {maScreen && maScreen == 'tiep-nhan-ho-so-truc-tuyen'
                  ?
                  <span> - {record.loaiDuLieuKetNoi == 'LTKS' || record.loaiDuLieuKetNoi == 'LTKT'
                    ? "Nộp qua Cổng DVC Liên thông"
                    : record.loaiDuLieuKetNoi == 'TBKM' || record.loaiDuLieuKetNoi == 'TBKMBS'
                      ? "Nộp qua Cổng DVC Quốc gia"
                      : "Nộp qua Cổng DVC"
                  }</span>
                  : null
                }
