...
const YeuCauThucHienNghiaVuTaiChinhTable = () => {
    ...
    const [searchParams, setSearchParams] = useState<ISearchHoSo>({ pageNumber: 1, pageSize: 50, reFetch: true, byCurrentUser: true, maTrangThai: "6"})
    ...
    const { columns } = useHoSoColumn({ pageNumber: searchParams.pageNumber, pageSize: searchParams.pageSize }, items, 'yeu-cau-thuc-hien-nghia-vu-tai-chinh')
    const rowSelection = {
