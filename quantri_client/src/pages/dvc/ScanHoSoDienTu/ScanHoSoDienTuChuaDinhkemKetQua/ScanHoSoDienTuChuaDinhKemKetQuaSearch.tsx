...
export const ScanHoSoDienTuChuaDinhKemKetQuaSearch = ({ setSearchParams, daKySo }: { setSearchParams: React.Dispatch<React.SetStateAction<ISearchHoSo>>, daKySo?: boolean }) => {
    ...
    const resetSearchParams = useCallback(() => {
        setSearchParams({ pageNumber: 1, pageSize: 50, reFetch: true,daKySo : false })
        form.resetFields()
    }, [])
