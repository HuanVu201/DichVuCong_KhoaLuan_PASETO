...
export const ThongKeDangKyNhanKqQuaBCCISearch = ({
  setSearchParams,
}: {
  ...
  const onFinish = (values: ISearchHoSo) => {
    ...
    const formData: ISearchHoSo = {
      ...
      tiepNhanFrom: values.tiepNhanFrom
        ? dayjs(values.tiepNhanFrom).format('YYYY/MM/DD')
        : undefined,
      tiepNhanTo: values.tiepNhanTo
        ? dayjs(values.tiepNhanTo).format("YYYY/MM/DDT23:59:59")
        : undefined,
      henTraFrom: values.henTraFrom
        ? dayjs(values.henTraFrom).format('YYYY/MM/DD')
        : undefined,
      henTraTo: values.henTraTo
        ? dayjs(values.henTraTo).format("YYYY/MM/DDT23:59:59")
        : undefined,
      dangKyBuuDienTuNgay: values.dangKyBuuDienTuNgay
        ? dayjs(values.dangKyBuuDienTuNgay).format('YYYY/MM/DD')
        : undefined,
      dangKyBuuDienDenNgay: values.dangKyBuuDienDenNgay
        ? dayjs(values.dangKyBuuDienDenNgay).format("YYYY/MM/DDT23:59:59")
        : undefined,
    };
