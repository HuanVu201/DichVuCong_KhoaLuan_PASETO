...
import { ThongKeDangKyNhanKqQuaBCCISearch } from "./ThongKeDangKyNhanKqQuaBCCISearch";
...
import { ThongKeDangKyNhanKqQuaBCCIProvider } from "../contexts/ThongKeDangKyNhanKqQuaBCCIContext";

const ThongKeDangKyNhanKqQuaBCCITable = () => {
  ...
  const { btnElememts } = useButtonActions({
    maScreen: screenType["thong-ke-dang-ky-nhan-kq-qua-bcci"],
  });
  ...
  return (
    <LazyActions setSearchParams={setSearchParams}>
      <AntdSpace direction="vertical" style={{ width: "100%" }}>
        ...
        <ThongKeDangKyNhanKqQuaBCCISearch setSearchParams={setSearchParams} />
...
const HoSoTableWrapper = () => (
  <ThongKeDangKyNhanKqQuaBCCIProvider>
    <ButtonActionProvider>
      <ThongKeDangKyNhanKqQuaBCCITable />
    </ButtonActionProvider>
  </ThongKeDangKyNhanKqQuaBCCIProvider>
);
