...
import { SearchHoSoToiHan } from "./HoSoToiHanSearch";
import { SearchHoSo } from "@/features/hoso/redux/action";
import { Col, Form, MenuProps, Radio, Spin } from "antd";
import {
  HoSoToiHanProvider,
...
import { useHoSoToiHanColumn } from "../hooks/useHoSoToiHanColumn";
...
const HoSoToiHanTable = () => {
  ...
  const { datas } = useAppSelector((state) => state.userroles);
  ...
  const { columns } = useHoSoToiHanColumn(
