...
export const useTuChoiTiepNhanHoSoColumn = (
  ...
  > => {
    return [
      ...
      {
        title: <p style={{ fontSize: 16, textAlign: 'center' }}>Đính kèm từ chối</p>,
        key: "dinhKemTuChoi",
        render: (_, record) => {
          return (
            <>
              <div style={{ display: 'flex', flexDirection: 'row', fontWeight: '500', alignItems: 'center', justifyContent: 'center' }}>
                {record.dinhKemTuChoi?.split(ID_SEPARATE).map((dinhKem, idx) =>
