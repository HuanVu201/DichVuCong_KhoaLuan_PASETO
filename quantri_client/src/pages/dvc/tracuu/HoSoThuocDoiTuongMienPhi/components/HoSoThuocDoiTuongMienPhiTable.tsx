...
import { HoSoThuocDoiTuongMienPhiSearch } from "./HoSoThuocDoiTuongMienPhiSearch";
import '../../../../../features/thongKe/ThongKe.scss'
import { useHoSoThuocDoiTuongMienPhiColumn } from "../hooks/useHoSoThuocDoiTuongMienPhiColumn";
import { toast } from "react-toastify";
import { Spin } from "antd";

const HoSoThuocDoiTuongMienPhiTable = () => {
    ...
    const [searchParams, setSearchParams] = useState<ISearchHoSoTraLaiXinRut>({
        pageNumber: 1,
        pageSize: 50,
        hinhThucThuPhi : "Đối tượng miễn phí"
    });
    ...
    const { columns } = useHoSoThuocDoiTuongMienPhiColumn(
                    ...
                    <AntdSpace direction="vertical" style={{ width: "100%" }}>
                        ...
                        <div className="thongKeSwapper">
                            <div className="headerThongKe">
                                <div className="title">
                                    <h6>Danh sách hồ sơ miễn thu phí</h6>
                                </div>
                        ...
                        <HoSoThuocDoiTuongMienPhiSearch searchParams={searchParams} setSearchParams={setSearchParams}
                            resetSearchParams={() => { }} />
                        <AntdTable
                            columns={columns}
                            dataSource={hoSoData}
