...
import { ISearchHoSoTraLaiXinRut } from "@/features/hoso/models";
import { current } from "@reduxjs/toolkit";
import { TRANG_THAI_HO_SOS } from "../../TatCaHoSo/components/TheoDoiTatCaHoSoTable";
import { filterOptions } from "@/utils";
import { LOAICHUHOSO_OPTIONS } from "@/features/hoso/data/formData";
...
export const HoSoThuocDoiTuongMienPhiSearch = ({
    searchParams,
    setSearchParams,
    resetSearchParams,
}: {
    searchParams: ISearchHoSoTraLaiXinRut
    setSearchParams: any;
    ...
    const [form] = Form.useForm<ISearchHoSoTraLaiXinRut>();
    ...
    useEffect(() => {
        ...
        // form.setFieldValue("traLaiTuNgay", tuNgay ? dayjs(tuNgay) : null);
        // form.setFieldValue("traLaiDenNgay", denNgay ? dayjs(denNgay) : null);
        ...
        setSearchParams({
            ...
            denNgay: form.getFieldValue("denNgay")
                ...
                : undefined,
            traLaiTuNgay: form.getFieldValue("traLaiTuNgay")
                ? dayjs(form.getFieldValue("traLaiTuNgay")).format("YYYY-MM-DD")
                : undefined,
            traLaiDenNgay: form.getFieldValue("traLaiDenNgay")
                ? dayjs(form.getFieldValue("traLaiDenNgay")).format("YYYY-MM-DD")
                : undefined,
            loaiDoiTuong: form.getFieldValue('loaiDoiTuong'),
    ...
    return (
        ...
        >
            ...
            <Row gutter={[8, 8]}>
                ...
                <Col hidden={userData?.typeUser == "Admin" ? false : true} md={6}>
