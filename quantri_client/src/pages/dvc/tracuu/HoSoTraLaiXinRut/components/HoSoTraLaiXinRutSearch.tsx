...
export const HoSoTraLaiXinRutSearch = ({
    searchParams,
    setSearchParams,
    resetSearchParams,
    onFinish
    ...
    return (
        ...
        >
            ...
            <Row gutter={[8, 8]}>
                ...
                <Col md={12} style={{ display: displayDate }}>
                    <Form.Item label="Trả lại/ xin rút từ ngày" name="traLaiTuNgay">
                        <DatePicker
                            placeholder="Chọn ngày"
                            format={"DD/MM/YYYY"}
                            style={{ width: "100%" }}
                ...
                <Col md={12} style={{ display: displayDate }}>
                    <Form.Item label="Trả lại/ xin rút đến ngày" name="traLaiDenNgay">
                        <DatePicker
                            placeholder="Chọn ngày"
                            format={"DD/MM/YYYY"}
                            style={{ width: "100%" }}
