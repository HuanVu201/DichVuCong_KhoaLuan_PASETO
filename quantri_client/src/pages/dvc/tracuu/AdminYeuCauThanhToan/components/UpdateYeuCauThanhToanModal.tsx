...
const TRANG_THAI: SelectProps["options"] = [
  { value: "Đã thanh toán", label: "Đã thanh toán" },
  { value: "Chờ thanh toán", label: "Chờ thanh toán" },
  { value: "Chưa thanh toán", label: "Chưa thanh toán" },
  { value: "Đã hoàn phí", label: "Đã hoàn phí" },
  { value: "Hủy thanh toán", label: "Hủy thanh toán" },
    ...
    (async () => {
      ...
      form.setFieldsValue({
        ...
        ngayYeuCau: yeuCauThanhToan?.data?.ngayYeuCau
          ...
          : undefined,
          ngayThuPhi: yeuCauThanhToan?.data?.ngayThuPhi
          ? dayjs(yeuCauThanhToan?.data?.ngayThuPhi)
          : undefined,
          ngayHoanPhi: yeuCauThanhToan?.data?.ngayHoanPhi
          ? dayjs(yeuCauThanhToan?.data?.ngayHoanPhi)
          : undefined,
      });
    })();
  }, []);
    ...
    >
      <Form form={form} layout="vertical">
        <Row gutter={[8, 0]}>
          ...
          <Col md={12} span={24}>
            <Form.Item name="donVi" label="Đơn vị yêu cầu">
              <AntdSelect
                generateOptions={{
                  model: groups,
                  value: "groupCode",
