...
import { useAdminYeuCauThanhToanContext } from "../contexts/AdminYeuCauThanhToanContext";
import { getCurrency } from "@/utils";
import { IYeuCauThanhToan } from "@/pages/dvc/thuphilephi/models/YeuCauThanhToan";
export const useAdminYeuCauThanhToanColumn = (
  pagination: IBasePagination,
  items: MenuProps["items"]
) => {
  const choThuPhiContext = useAdminYeuCauThanhToanContext();
