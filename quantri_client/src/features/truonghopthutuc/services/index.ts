...
export class TruongHopThuTucService extends Service.BaseApi implements Service.ICrud<ITruongHopThuTuc>{
    ...
    SearchTheoDonVi(_params: ISearchTruongHopThuTuc): AxiosResponseWrapper<IPaginationResponse<ITruongHopThuTuc[]>> {
    ...
    GetByMa(maTruongHop: string): AxiosResponseWrapper<IResult<ITruongHopThuTuc>> {
        return axiosInstance.get(this._urlSuffix + "/matruonghop/" + maTruongHop);
    }
