...
import {GetDuLieuThemHoSo, AddTruongHopThuTuc, DeleteTruongHopThuTuc, GetByHoSoId, GetTruongHopThuTuc, SearchTruongHopThuTuc, UpdateTruongHopThuTuc, UpdateTruongHopThuTucWithoutSearch, GetTruongHopThuTucByMa, SearchTruongHopThuTucTheoDonVi } from "./action";
...
const Slice = createGenericSlice({
    ...
    extraReducers:(builder) => {
        builder
            ...
            .addCase(SearchTruongHopThuTucTheoDonVi.fulfilled, (state, action) => {
                state.loading = false
                state.datas = action.payload.data
                state.count = action.payload.totalCount
            })
            ...
            .addCase(GetTruongHopThuTucByMa.fulfilled, (state, action) => {
                state.loading = false
                state.data = action.payload.data
            })
            ...
            .addMatcher(isPending(GetByHoSoId,GetTruongHopThuTucByMa, SearchTruongHopThuTuc,SearchTruongHopThuTucTheoDonVi, GetDuLieuThemHoSo, GetTruongHopThuTuc, AddTruongHopThuTuc, UpdateTruongHopThuTuc, DeleteTruongHopThuTuc), (state) => {
                state.loading = true
            })
            .addMatcher(isRejectedWithValue(SearchTruongHopThuTuc,SearchTruongHopThuTucTheoDonVi,GetTruongHopThuTucByMa, GetTruongHopThuTuc, AddTruongHopThuTuc, UpdateTruongHopThuTuc, DeleteTruongHopThuTuc), (state, action) => {
