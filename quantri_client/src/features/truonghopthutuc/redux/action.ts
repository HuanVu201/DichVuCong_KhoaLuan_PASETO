...
export const SearchTruongHopThuTuc =
    ...
    export const SearchTruongHopThuTucTheoDonVi =
    createAsyncThunk<IPaginationResponse<ITruongHopThuTuc[]>, IPickSearch<ITruongHopThuTuc, "thuTucId">>("SearchTruongHopThuTucTheoDonVi", async (params, thunkApi) => {
        try {
            const res = await truongHopThuTucApi.SearchTheoDonVi(params)
            return res.data
        } catch (error) {
            return thunkApi.rejectWithValue(error)
        }
...
export const GetTruongHopThuTucByMa =
    createAsyncThunk<IResult<ITruongHopThuTuc>, string>("GetTruongHopThuTucByMa", async (ma, thunkApi) => {
        try {
            const res = await truongHopThuTucApi.GetByMa(ma);
            return res.data
        } catch (error) {
            return thunkApi.rejectWithValue(error)
        }
