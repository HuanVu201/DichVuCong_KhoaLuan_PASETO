...
import { NgayLamViecNgayModal } from "./NgayLamViecNgayModal";
...
const ReactFlowInner = (props: CustomReactFlowProps) => {
    ...
    const nodeTypes = useMemo(() => ({
        customNode: (props: Node<IQuyTrinhXuLy>) => <CustomNode onEdit={onEdit} {...props} />,
    ...
    return <>
        <AntdModal visible={true} title="Chỉnh sửa quy trình" fullsize footer={null} handlerCancel={handlerCancel} afterOpenChange={(open) => {
            ...
            <AntdSpace direction="horizontal" style={{ marginBottom: 12 }}>
                ...
                <AntdButton style={{ marginBottom: 6 }} onClick={() => truongHopThuTucContext.setNgayLamViecNgayModalVisible(true)}>Chuyển đổi Ngày, Ngày làm việc</AntdButton>
            </AntdSpace>
        ...
        {truongHopThuTucContext.ngayLamViecNgayModalVisible ? <NgayLamViecNgayModal edges = {edges} addNode={onAddNode} onChangeNode={onChangeNode} nodes={nodes} /> : null}
    </>
