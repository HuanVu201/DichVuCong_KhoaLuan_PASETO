...
export const useColumnQTDVTruongHopThuTuc = (pagination: IBasePagination, setSearchParams: React.Dispatch<React.SetStateAction<ISearchTruongHopThuTuc>>) => {
    ...
    const columns = useMemo((): ColumnsType<ITruongHopThuTuc> => {
        return [
            ...
            {
                title: "Thời gian thực hiện trực tuyến",
                key: "thoiGianThucHienTrucTuyen",
                dataIndex: "thoiGianThucHienTrucTuyen",
                align: 'center',
                render: (text, record) => {
            ...
            },
            {
                ...
                render: (_, record) => (
                    <Space direction="horizontal">
                        ...
                        <NodeIndexOutlined title='Xem quy trình' onClick={() => {
                            truongHopThuTucContext.setTruongHopThuTucId(record.id)
