...
import { DanTocMap, danTocMap, TonGiaoMap, tonGiaoMap, GioiTinhMap, gioiTinhMap, TinhTrangHonNhanMap, tinhTrangHonNhanMap } from '../datamap/datamap';
...
export const ChiTietNguoiDung = ({ form }: { form: FormInstance<ChiTietNguoiDung> }) => {
    ...
    const tinhTrangHonNhan = tinhTrangHonNhanMap[userCDSLDanCu?.tinhTrangHonNhan as any];
    const tonGiao = tonGiaoMap[userCDSLDanCu?.tonGiao as any];
    const gioiTinh = gioiTinhMap[userCDSLDanCu?.gioiTinh as any];
    const danToc = danTocMap[userCDSLDanCu?.danToc as any];
    let ngayThangNamSinhObject, ngayThangNam, ngayThangNamFormatted,ho,ten
    try {
        ngayThangNamSinhObject = JSON.parse(userCDSLDanCu?.ngayThangNamSinh as any);
        ngayThangNam = ngayThangNamSinhObject.NgayThangNam;
        ngayThangNamFormatted = formatNgayThangNam(ngayThangNam);
        const [ho, ...tenArr] = userCDSLDanCu?.fullName.split(" ") as any;
   ...
   // Nếu tên có nhiều hơn 1 từ
    ...
    function formatNgayThangNam(ngayThangNam: string): string {
        const year = ngayThangNam.slice(0, 4);
        const month = ngayThangNam.slice(4, 6);
        const day = ngayThangNam.slice(6, 8);
    ...
    return <Form form={form} name="ThongTinCSDLDanCuData" layout="vertical" disabled>
        <Row gutter={[24, 8]} >
            ...
            <Col md={12} span={24}>
                <Form.Item label="Họ">
                    <Input defaultValue={ho} value={ho} />
                </Form.Item>
            </Col>
            <Col md={12} span={24}>
                <Form.Item label="Tên">
                    <Input defaultValue={ten} value={ten} />
                </Form.Item>
            </Col>
            <Col md={12} span={24}>
            ...
            <Col md={12} span={24}>
                <Form.Item label="Tình trạng hôn nhân">
                    <Input defaultValue={tinhTrangHonNhan} value={tinhTrangHonNhan} />
                </Form.Item>
            </Col>
            <Col md={12} span={24}>
            ...
            <Col md={12} span={24}>
                <Form.Item label="Tôn giáo">
                    <Input defaultValue={tonGiao} value={tonGiao} />
                </Form.Item>
            </Col>
            <Col md={12} span={24}>
            ...
            <Col md={12} span={24}>
                <Form.Item label="Giới tính">
                    <Input defaultValue={gioiTinh} value={gioiTinh} />
                </Form.Item>
            </Col>
            <Col md={12} span={24}>
                <Form.Item label="Dân tộc">
                    <Input defaultValue={danToc} value={danToc} />
                </Form.Item>
            </Col>
            <Col md={12} span={24}>
            ...
            <Col md={12} span={24}>
                <Form.Item label="Ngày tháng năm sinh">
                    <Input defaultValue={ngayThangNamFormatted} value={ngayThangNamFormatted} />
                </Form.Item>
            </Col>
            <Col span={24}>
