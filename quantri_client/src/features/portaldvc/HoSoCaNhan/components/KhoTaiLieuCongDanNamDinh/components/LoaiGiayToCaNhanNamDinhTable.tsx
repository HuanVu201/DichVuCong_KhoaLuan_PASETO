...
export default function LoaiGiayToCaNhanTable() {
    ...
    const { columns } = useLoaiNhomGiayToCaNhanColumn({ pageNumber: searchParams.pageNumber, pageSize: searchParams.pageSize, searchParams: searchParams, setSearchParams: setSearchParams, type: 'loại giấy tờ' })
