...
import { TaiLieuDienTuProvider, useTaiLieuDienTuContext } from "../context/TaiLieuDienTu/TaiLieuDienTuContext";
import { TaiLieuDienTuDetail } from "../../../hoso/components/actions/themMoiHoSo/TaiLieuDienTuDetail";

function TaiLieuDienTuTable() {
    ...
    return (
        <div className="taiLieuDienTu">
            ...
            <div className="content">
                <span style={{ fontWeight: 700 }}>Danh sách các giấy tờ</span>
...
const TaiLieuDienTuComponent = () => (<TaiLieuDienTuProvider>
    <TaiLieuDienTuTable />
</TaiLieuDienTuProvider>)
