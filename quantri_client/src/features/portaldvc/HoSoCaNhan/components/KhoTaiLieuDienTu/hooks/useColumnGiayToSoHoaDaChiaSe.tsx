...
import { CloudUploadOutlined, DeleteOutlined, DownloadOutlined, EyeOutlined, LinkOutlined, LoginOutlined, ShareAltOutlined, UndoOutlined } from '@ant-design/icons'
...
export const useColumnGiayToSoHoaDaChiaSe = () => {
                ...
                render: (_, record) => {
                    return <div style={{ display: 'flex', justifyContent: 'center', gap: 5, flexWrap: 'wrap' }}>
                        <Popconfirm
                            title='Thu hồi?'
                            onConfirm={() => {
                                khoTaiLieuDienTuContext.setGtshThuHoiChiaSeId(record.id)
                            }}
                            okText='Thu hồi'
                            cancelText='Huỷ'

                        >
                            <UndoOutlined style={{ color: "tomato" }} />
                        </Popconfirm>
                    </div>
                }
            },
