...
import "./DetailThuTucPortal.scss";
...
import VideoPlayerDemo from "./VideoPlayerTutorial";
import VideoPlayerTutorial from "./VideoPlayerTutorial";

export interface IGoiTinThuTucQuocGia {
...
function DetailThuTucPortal() {
  ...
  useEffect(() => {
    (async () => {
      if (thuTucPortalContext.thuTucId) {
        const resThuTuc = await thuTucPortalService.Get(
  ...
  useEffect(() => {
    ...
    if (thuTuc?.goiTinThuTucQG) {
      ...
      if (tmp_tenTrinhTu_TrinhTuThucHien)
        tmp_tenTrinhTu_TrinhTuThucHien = JSON.stringify(
          tmp_tenTrinhTu_TrinhTuThucHien.replace(/\n/g, "<br>")
        );
      ...
      obj.CACHTHUCTHUCHIEN?.map((item1: any) => {
        ...
        item1.THOIGIAN?.map((item2: any) => {
          tmp_cachThucThucHien += item2.THOIGIANGIAIQUYET
            ? `${item2.THOIGIANGIAIQUYET} ${item2.DONVITINH.includes('Khác') ? "": item2.DONVITINH} <br/>`
            : `<br/>`
        });
        tmp_cachThucThucHien = tmp_cachThucThucHien
          ? tmp_cachThucThucHien.slice(0, -5)
          : "";
      ...
      if (tmp_tenDoiTuong_DoiTuongThucHien)
        tmp_tenDoiTuong_DoiTuongThucHien = JSON.stringify(
          tmp_tenDoiTuong_DoiTuongThucHien.replace(/\n/g, "<br>")
        );
      ...
      if (tmp_tenDonVi_CoQuanThucHien)
        tmp_tenDonVi_CoQuanThucHien = JSON.stringify(
          tmp_tenDonVi_CoQuanThucHien.replace(/\n/g, "<br>")
        );
      ...
      if (tmp_tenDonVi_CoQuanCoThamQuyen)
        tmp_tenDonVi_CoQuanCoThamQuyen = JSON.stringify(
          tmp_tenDonVi_CoQuanCoThamQuyen.replace(/\n/g, "<br>")
        );

      tmp_diaChiTiepNhan = obj.DIACHITIEPNHAN;
      if (tmp_diaChiTiepNhan)
        tmp_diaChiTiepNhan = JSON.stringify(
          tmp_diaChiTiepNhan.replace(/\n/g, "<br>")
        );
      ...
      if (tmp_tenDonVi_CoQuanDuocUyQuyen)
        tmp_tenDonVi_CoQuanDuocUyQuyen = JSON.stringify(
          tmp_tenDonVi_CoQuanDuocUyQuyen.replace(/\n/g, "<br>")
        );
      ...
      if (tmp_tenDonVi_CoQuanPhoiHop)
        tmp_tenDonVi_CoQuanPhoiHop = JSON.stringify(
          tmp_tenDonVi_CoQuanPhoiHop.replace(/\n/g, "<br>")
        );
      ...
      if (tmp_tenKetQua_KetQuaThucHien)
        tmp_tenKetQua_KetQuaThucHien = JSON.stringify(
          tmp_tenKetQua_KetQuaThucHien.replace(/\n/g, "<br>")
        );
      ...
      tmp_moTa = obj.MOTA;
      if (tmp_moTa) tmp_moTa = JSON.stringify(tmp_moTa.replace(/\n/g, "<br>"));

      setGoiTin({
        ...goiTin,
        tenCap_CapThucHien: tmp_tenCap_CapThucHien
          ? tmp_tenCap_CapThucHien.slice(0, -5)
          : "",
        loaiTTHC: tmp_loaiTTHC,
        tenLinhVuc_LinhVucThucHien: tmp_tenLinhVuc_LinhVucThucHien
          ? tmp_tenLinhVuc_LinhVucThucHien.slice(0, -5)
          : "",
        tenTrinhTu_TrinhTuThucHien: tmp_tenTrinhTu_TrinhTuThucHien
          ? tmp_tenTrinhTu_TrinhTuThucHien.slice(1, -6)
          : "",
        cachThucThucHien: tmp_cachThucThucHien,
        thanhPhanHoSo: tmp_thanhPhanHoSo,
        tenDoiTuong_DoiTuongThucHien: tmp_tenDoiTuong_DoiTuongThucHien
          ? tmp_tenDoiTuong_DoiTuongThucHien.slice(1, -6)
          : "",
        tenDonVi_CoQuanThucHien: tmp_tenDonVi_CoQuanThucHien
          ? tmp_tenDonVi_CoQuanThucHien.slice(1, -6)
          : "",
        tenDonVi_CoQuanCoThamQuyen: tmp_tenDonVi_CoQuanCoThamQuyen
          ? tmp_tenDonVi_CoQuanCoThamQuyen.slice(1, -6)
          : "",
        diaChiTiepNhan: tmp_diaChiTiepNhan
          ? tmp_diaChiTiepNhan.slice(1, -1)
          : "",
        tenDonVi_CoQuanDuocUyQuyen: tmp_tenDonVi_CoQuanDuocUyQuyen
          ? tmp_tenDonVi_CoQuanDuocUyQuyen.slice(1, -6)
          : "",
        tenDonVi_CoQuanPhoiHop: tmp_tenDonVi_CoQuanPhoiHop
          ? tmp_tenDonVi_CoQuanPhoiHop.slice(1, -6)
          : "",
        tenKetQua_KetQuaThucHien: tmp_tenKetQua_KetQuaThucHien
          ? tmp_tenKetQua_KetQuaThucHien.slice(1, -6)
          : "",
    ...
    if (thuTuc?.quyetDinhCongBo) {
      ...
      setQDCB({
        ...qdcb,
        soQuyetDinh_QDCB: obj.SOQUYETDINH,
        ngayQuyetDinh_QDCB: formattedDate,
        trichYeu_QDCB: obj.TRICHYEU,
      });
    }
  }, [thuTuc]);
  ...
  return (
    <div className="chi-tiet-thu-tuc-dvcqg" style={{ padding: 0 }}>
      ...
      <VideoPlayerTutorial videoTutorial={thuTuc?.urlVideoTutorial || ''} />

      <div className="actionThuTucDetail" style={{ justifyContent: 'space-between', alignItems: 'center' }}>
        <div className="btn_actionThuTucDetail" style={{ backgroundColor: '#0dcaf0', color: '#fff', cursor: 'pointer' }}
          onClick={() => {
            thuTucPortalContext.setThuTucId("");
            thuTucPortalContext.handleUrlQueryStringChange({
              MaThuTuc: "",
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <div hidden={thuTuc?.urlVideoTutorial ? false : true}
            className="openVideoTutorial btn_actionThuTucDetail"
            onClick={() => {
          ...
          <div
            className="download btn_actionThuTucDetail"
            onClick={() => downloadPhieuWord(`${thuTuc?.tenTTHC}`)}
          >
            <span><FileWordOutlined style={{ marginRight: "10px", fontSize: "16px" }} />
              Word</span>
          </div>
          <div className="nopTrucTuyen btn_actionThuTucDetail" style={{ backgroundColor: '#ce7a58', cursor: 'pointer' }}
            onClick={(e) => {
              if (!user) {
              ...
              else if(thuTuc?.mucDo == '2'){
                toast.info("Thủ tục đã chọn không phải là thủ tục toàn trình, một phần")
              }
              else {
                navigate(`${Service.primaryRoutes.portaldvc.nopHoSoTrucTuyen}?maTTHC=${thuTuc?.maTTHC}`)
              }
            }}>
            <span><LoginOutlined style={{ marginRight: "10px", fontSize: "16px" }} />
              Nộp hồ sơ trực tuyến</span>
          </div>
        </div>
      ...
      <div className="content" id="ContainerSwapper">
        <table style={{ width: "100%" }}>
          ...
          <tbody>
            <tr>
              <td
                className="key titleColumnn"
                style={{ verticalAlign: "top", padding: "3px 10px" }}
              >
                <b>Mã thủ tục:</b>
              </td>
              <td
              ...
              >
                <div
                  dangerouslySetInnerHTML={{ __html: thuTuc?.maTTHC || "" }}
                />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{ __html: thuTuc?.tenTTHC || "" }}
                />
              </td>
            </tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenCap_CapThucHien || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{ __html: goiTin?.loaiTTHC || "" }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenLinhVuc_LinhVucThucHien || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenTrinhTu_TrinhTuThucHien || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.cachThucThucHien || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenDoiTuong_DoiTuongThucHien || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenDonVi_CoQuanThucHien || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenDonVi_CoQuanCoThamQuyen || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenDonVi_CoQuanDuocUyQuyen || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenDonVi_CoQuanPhoiHop || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html: goiTin?.tenKetQua_KetQuaThucHien || "",
                  }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <b>Yêu cầu, điều kiện thực hiện:</b>
              </td>
              <td
                className="contentColumn"
                style={{
              ...
              >
                <div
                  dangerouslySetInnerHTML={{ __html: goiTin?.yeuCau || "" }}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              >
                <div
                  dangerouslySetInnerHTML={{ __html: goiTin?.tuKhoa || "" }}
                />
              </td>
            </tr>
      ...
      <div className="actionThuTucDetail" style={{ justifyContent: 'right', gap: 10 }}>
...
export default DetailThuTucPortal;
