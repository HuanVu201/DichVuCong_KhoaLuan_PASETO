    ...
    return (
        <>
            ...
            >
                ...
                <div id="ContainerSwapper" style={{ fontSize: "13px", cursor: 'default' }}>
                    ...
                    >
                        <thead id="headerTable">
                            ...
                            <tr>
                                <td className='tdHeader tdData' rowSpan={2} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #dfb6a5' }}>
                                    <strong>Tổng số</strong>
                                </td>
                                <td className='tdHeader tdData' rowSpan={2} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #dfb6a5' }}>
                                    <strong>Kỳ trước chuyển sang</strong>
                                </td>
                                <td className='tdHeader tdData' colSpan={4} style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #dfb6a5' }}>
                            ...
                            <tr>
                                <td className='tdHeader tdData' style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #dfb6a5' }}>
                                    <strong>Tổng số</strong>
                                </td>
                                <td className='tdHeader tdData' style={{ verticalAlign: 'middle', padding: '5px', border: '1px solid #dfb6a5' }}>
