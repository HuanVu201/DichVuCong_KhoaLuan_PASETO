...
import { useColumn } from "./RightSideColumn"
import { AntdSpace, AntdTable } from "@/lib/antd/components"
import { SearchUser } from "@/features/user/redux/Actions"
import { Table } from "antd"
import { IPaginationResponse } from "@/models"
import { RightSideChuyenDLTKSearch } from "./RightSideSearch"

const RightSideChuyenDLTKTable = () => {
    ...
    return (
        <>
            <AntdSpace direction="vertical" style={{ width: "100%" }}>
                <RightSideChuyenDLTKSearch onUpdateDataSource={updateDataSource} />
                <Table
                    bordered
...
//     <ConfigTable />
// </ConfigProvider>)
export default RightSideChuyenDLTKTable