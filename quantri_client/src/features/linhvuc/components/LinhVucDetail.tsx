...
export const LinhVucDetail = () => {
    ...
    return (
        <AntdModal title={linhVucContext.linhVucId ? `Sửa thông tin lĩnh vực` : `Thêm mới lĩnh vực`} visible={linhVucContext.linhVucModalVisible} handlerCancel={handleCancel} footer={null}>
