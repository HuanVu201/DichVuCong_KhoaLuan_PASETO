...
export const useHoSoColumn = (pagination: IBasePagination) => {
                ...
                render: (_, record) => (
                    <Space direction="horizontal">
                        <EyeOutlined style={{ color: "cornflowerblue" }} title="Xem chi tiết" onClick={() => {
                            ...
                            qlvbContext.setHoSoDetailModalVisible(true)
                        ...
                        <RetweetOutlined style={{ color: "orange" }} title="Gửi lại gói tin" onClick={() => {
                            ...
                            (async () => {
                                ...
                                try {
                                    const response = await axiosCustomQlvb.post(`${qlvbContext.configApiString?.urlapi}/lienthonghsqlvb/CapNhatTrangThaiHoSo`, requestBody, {
                                        headers: {}
                                    });
                                    ...
                                    console.error('Error /lienthonghsqlvb/CapNhatTrangThaiHoSo:', error);
                                }
