...
export const VanBanLienThongQLVBSearch = ({ setSearchParams }: { setSearchParams: React.Dispatch<React.SetStateAction<IQLVBSearchParams>> }) => {
    ...
    const resetSearchParams = useCallback(() => {
        setSearchParams({ ...qlvbContext.searchParams, LoaiGoiTin: 'Văn bản', search: { value: '' } })
        form.resetFields()
    }, [])
    return (

        <Form name='VanBanSearch' layout="vertical" onFinish={onFinish} form={form}>
            <Row gutter={[8, 8]}>
