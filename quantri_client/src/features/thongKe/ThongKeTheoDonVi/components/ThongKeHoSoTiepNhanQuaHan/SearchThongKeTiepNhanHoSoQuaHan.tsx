...
export const SearchThongKeHoSoTiepNhanQuaHan = ({
  setSearchParams,
  resetSearchParams,
  loaiDonViThongKe,
  onFinish,
  ...
  useEffect(() => {
    ...
    if (loaiDonViThongKe == "donvi") {
      setSearchParams({
        ...
        tiepNhanTuNgay: form.getFieldValue("tuNgay")
          ? dayjs(form.getFieldValue("tuNgay")).format("YYYY-MM-DD")
          : null,
        tiepNhanDenNgay: form.getFieldValue("denNgay")
      ...
      if (tuNgayData && denNgayData) {
        ...
        if (thongKeToanDonVi == "toanbo") {
          ...
          setSearchParams((curr: any) => ({
            ...
            maDinhDanh: undefined,
            tiepNhanTuNgay: tuNgayData,
            tiepNhanDenNgay: denNgayData,
      ...
      >
        ...
        {/* <Row gutter={[8, 8]} style={{ display: 'flex' }}>
          ...
          <Col span={8}>
            <Form.Item label="Mức độ" name="mucDo">
              <AntdSelect
                generateOptions={{ model: MUCDO_OPTIONS, label: "label", value: "value" }}
                showSearch
                allowClear
                filterOption={filterOptions}
              />
        ...
        <Row gutter={[8, 8]} style={{ display: 'flex' }}>
          ...
          <Col style={{ display: displayDate, flex: 1 }}>
            <Form.Item label="Tiếp nhận từ ngày" name="tuNgay">
              <DatePicker
          ...
          <Col style={{ display: displayDate, flex: 1 }}>
            <Form.Item label="Tiếp nhận đến ngày" name="denNgay">
              <DatePicker
                placeholder="Chọn ngày"
                format={"DD/MM/YYYY"}
                style={{ width: "100%" }}
