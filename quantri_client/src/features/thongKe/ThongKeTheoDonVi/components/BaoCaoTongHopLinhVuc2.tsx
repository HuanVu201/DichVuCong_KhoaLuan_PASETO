...
import { XuatBaoCaoTongHopLinhVuc2Modal } from "./exportElements/XuatBaoCaoTongHopLinhVuc2";
...
const BaoCaoTongHopLinhVuc2 = () => {
      ...
      <tr>
        ...
        >
          {item.trangThaiBoSung ? (
            <Link to="" onClick={() => handleLoadHoSo(item, "TrangThaiBoSung")}>
        ...
        >
          {item.trangThaiDungXuLy ? (
            <Link to="" onClick={() => handleLoadHoSo(item, "TrangThaiDungXuLy")}>
        ...
        >
          {item.trangThaiYeuCauThucHienNVTC ? (
            <Link to="" onClick={() => handleLoadHoSo(item, "TrangThaiYeuCauThucHienNVTC")}>
  ...
  return (
    <div className="thongKeSwapper">
      ...
      <XuatBaoCaoTongHopLinhVuc2Modal data={data} thongKeToanBo={thongKeToanBo}
...
export const CountDataBaoCaoTongHopLinhVuc = ({
  ...
  const [tongSoTotal, tiepNhanKyTruocTotal, tiepNhanTrongKyTotal,
    ...
    daXuLyDungHanTotal, daXuLyQuaHanTotal, dangXuLyTrongHanTotal, dangXuLyQuaHanTotal, tongBoSungTotal, tongTraLaiTotal, trangThaiBoSung, trangThaiDungXuLy, trangThaiYeuCauThucHienNVTC
  ] = useMemo(() => {
    ...
    data?.forEach((item: IBaoCaoDonVi) => {
      ...
      trangThaiBoSung += item.trangThaiBoSung
      trangThaiDungXuLy += item.trangThaiDungXuLy
      trangThaiYeuCauThucHienNVTC += item.trangThaiYeuCauThucHienNVTC
    })
  ...
  return (
    <tr>
      ...
      >
        {getCurrencyThongKe(trangThaiBoSung)}
      </td>
      <td
        style={{
          verticalAlign: "middle", textAlign: "right", padding: "5px",
      ...
      >
        {getCurrencyThongKe(trangThaiDungXuLy)}
      </td>
      <td
        style={{
          verticalAlign: "middle", textAlign: "right", padding: "5px",
      ...
      >
        {getCurrencyThongKe(trangThaiYeuCauThucHienNVTC)}
      </td>
      <td
        style={{
          verticalAlign: "middle",
