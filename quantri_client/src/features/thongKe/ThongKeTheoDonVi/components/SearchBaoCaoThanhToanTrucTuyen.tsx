...
import { IThanhToanTrucTuyenParams } from "../../thongKeQD766/models/ThongKeQD766Search";
import { useThanhToanTrucTuyenContext } from "../../thongKeQD766/context/ThongKeQD766Context";
...
export const SearchBaoCaoThanhToanTrucTuyen = ({
  setSearchParams,
  resetSearchParams,
  loaiDonViThongKe,
  onFinish,
  ...
  onFinish: (value: IThanhToanTrucTuyenParams) => void;
