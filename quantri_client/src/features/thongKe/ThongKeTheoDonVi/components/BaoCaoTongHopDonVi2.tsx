...
import { SearchBaoCaoTongHopDonVi2 } from "./SearchBaoCaoTongHopDonVi2";
...
const BaoCaoTongHopDonVi = () => {
  ...
  const handleLoadHoSo = (item: any, tieuChi?: string) => {
    ...
    hoSoTheoBaoCaoTongHopContext.setSearchParams({
      ...
      tieuChi: tieuChi,
      MaLinhVucChinh: thongKeHoSoContext.searchBaoCaoThuTuc.linhVucId,
  ...
  const countSumary = () => {
    ...
    let trangThaiBoSung: number = 0
    let trangThaiDungXuLy: number = 0
    let trangThaiYeuCauThucHienNVTC: number = 0
    data.forEach(item => {
