...
import { SearchBaoCaoTheoThuTuc } from "./SearchBaoCaoTheoThuTuc";
import { XuatBaoCaoTongHopThuTucModal } from "./exportElements/XuatBaoCaoTongHopThuTuc";
...
const BaoCaoTongHopThuTuc = () => {
  ...
  return (
    <div className="thongKeSwapper">
      ...
      <XuatBaoCaoTongHopThuTucModal data={data} thongKeToanBo={thongKeToanBo }
