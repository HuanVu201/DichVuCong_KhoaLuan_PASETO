...
export const ThongKeTheoDoiTrangThaiHoSoSearch = ({ setSearchParams, onFinish, searchParams }: { searchParams?: ThongKeHSLTParams, onFinish: (value: ThongKeHSLTParams) => void; setSearchParams: React.Dispatch<React.SetStateAction<ThongKeHSLTParams>> }) => {
