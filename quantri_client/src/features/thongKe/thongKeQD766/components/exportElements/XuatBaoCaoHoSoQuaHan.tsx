...
export const XuatBaoCaoHoSoQuaHanTable = ({
    hoSos,
    userData,
    tuNgay,
    denNgay,
    ...
    var [dataDaXuLyQuaHan, setDataDaXuLyQuaHan] = useState<IHoSoTheoTrangThaiXuLy[]>([]);
    // useEffect(() => {
    //     if (userData) {
    //         if (
    //             searchParams.tuNgay &&
    ...
    useEffect(() => {
        if (hoSos && hoSos.length > 0) {
            ...
            const groupedDaXuLy = hoSos.reduce((acc: any, item: any) => {
            ...
            setDataDaXuLyQuaHan(Object.values(groupedDaXuLy) ?? []);
            setTimeout(() => {
                export2Word(
    ...
    return <div>
        <div
            id="ContainerSwapper2"
            className="ContainerSwapper2"
            style={{
                fontSize: "13px",
                display: "none"
            }}
        >
            {dataDaXuLyQuaHan && dataDaXuLyQuaHan.length > 0 ? <>
                <table
                    style={{
                ...
                >
                    <thead>
                        <tr>
                            ...
                            >
                                <strong>Phụ lục I</strong>
                                <br />
                                <strong>DANH SÁCH ĐƠN VỊ, CÁ NHÂN CHẬM TRỄ TRONG VIỆC GIẢI QUYẾT HỒ SƠ TTHC</strong>
                                <br />
                ...
                >
                    ...
                    <tbody id="data">
                        {dataDaXuLyQuaHan?.map((item, index) => {
                                            ...
                                            return <tr>
                                                ...
                                                >
                                                    {hoSo.ngayKetThucXuLy
                                                        ? dayjs(hoSo.ngayKetThucXuLy).format(
                                                            "DD/MM/YYYY"
                                                        )
                                                        : ""}
                                                </td>
