...
class ThongKeQD766Services extends Service.BaseApi {
  ...
  SearchDonDocThanhToanTrucTuyen(
    _params: ISearchThongKeParams
  ): AxiosResponseWrapper<IThongKeQD766DonDocTTTTResponse> {
    return axiosInstance.post(this._urlSuffix + "/ChiTieuTTTT2", _params);
  }
  TienDoGiaiQuyetNew(
    _params: ISearchThongKeParams
  ...
  ChiTieuDVCTrucTuyenNew(
    ...
    return axiosInstance.post(
      this._urlSuffix + "/chitieudvctructuyen",
      _params
    );
  }
  ChiTieuSoHoaNew(
  ...
  TongHopTTHC(
    _params: ISearchThongKe766TTHCParams
  ): AxiosResponseWrapper<IThongKe766TTHCResponse> {
    return axiosInstance.post(this._urlSuffix + "/ThongKeTTHC", _params);
  }
}
