...
import { AddOrUpdateVaiTro, AddVaiTro, DeleteVaiTro, GetPermissionVaiTro, GetVaiTro, SearchPermissionsVaiTro, SearchVaiTro, UpdateVaiTro } from "./action";
...
const Slice = createGenericSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(AddOrUpdateVaiTro.fulfilled, () => {
                toast.success("Thao tác thành công")
            })
            .addCase(AddOrUpdateVaiTro.rejected, (state, action) => {
                toast.warning(action.payload?.exception)
            })
            ...
            .addMatcher(isPending(SearchVaiTro, GetVaiTro, AddVaiTro, UpdateVaiTro, DeleteVaiTro, AddOrUpdateVaiTro), (state) => {
                state.loading = true
            })
