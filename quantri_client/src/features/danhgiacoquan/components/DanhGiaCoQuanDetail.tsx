...
import { AddDanhGiaCoQuan, GetDanhGiaCoQuan, SearchDanhGiaCoQuan, UpdateDanhGiaCoQuan } from "../redux/action"
...
export const DanhGiaCoQuanDetail = () => {
    ...
    const onFinish = async () => {
        ...
        if (responseUpdate.succeeded)
            dispatch(SearchDanhGiaCoQuan({ pageNumber: 1, pageSize: 50, reFetch: true, maDinhDanh: user?.maDinhDanh, quy: currentQuarter, nam: currentYear }))
        handleCancel()
    }
