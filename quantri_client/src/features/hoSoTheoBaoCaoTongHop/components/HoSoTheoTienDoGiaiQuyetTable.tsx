...
const HoSoTheoTienDoGiaiQuyetTable = () => {
  ...
  useEffect(() => {
    dispatch(
      SearchHoSoTheoTienDoGiaiQuyet(hoSoTheoBaoCaoTongHopContext.searchParams)
    );
...
const HoSoTheoTienDoGiaiQuyetWrapper = () => (
  <ButtonActionProvider>
    <HoSoTheoTienDoGiaiQuyetTable />
  </ButtonActionProvider>
);
export default HoSoTheoTienDoGiaiQuyetWrapper;
