...
const HoSoTheoBaoCaoTiepNhanBuuChinhTable = () => {
    ...
    const { columns } = useHoSoThongKeTiepNhanBuuChinhColumn(
        {
            pageNumber: hoSoTheoBaoCaoTongHopContext.searchThongKeHoSoTiepNhan.pageNumber,
            pageSize: hoSoTheoBaoCaoTongHopContext.searchThongKeHoSoTiepNhan.pageSize,
        },
        items
    );
    useEffect(() => {
            dispatch(
                SearchHoSo(hoSoTheoBaoCaoTongHopContext.searchThongKeHoSoTiepNhan)
            );
    }, [hoSoTheoBaoCaoTongHopContext.searchThongKeHoSoTiepNhan]);
    return (
        <AntdModal
            visible={true}
            ...
            footer={null}
            handlerCancel={() =>
                hoSoTheoBaoCaoTongHopContext.setHoSoTiepNhanBuuChinhModalVisible(false)
            }
        >
            <LazyActions
                setSearchParams={hoSoTheoBaoCaoTongHopContext.setsearchThongKeHoSoTiepNhan}
            >
                ...
                <AntdSpace direction="vertical" style={{ width: "100%" }}>
                    ...
                    <Spin spinning={loading}>
                        <AntdTable
                            ...
                            loading={loading}
                            searchParams={hoSoTheoBaoCaoTongHopContext.searchThongKeHoSoTiepNhan}
                            setSearchParams={hoSoTheoBaoCaoTongHopContext.setsearchThongKeHoSoTiepNhan}
                            onSearch={(params) => { }}
                        />
                    </Spin>
...
const HoSoTheoBaoCaoTiepNhanBuuChinhWrapper = () => (
    <ButtonActionProvider>
        <HoSoTheoBaoCaoTiepNhanBuuChinhTable />
    </ButtonActionProvider>
);
export default HoSoTheoBaoCaoTiepNhanBuuChinhWrapper;
