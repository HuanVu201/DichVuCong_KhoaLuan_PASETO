...
const HoSoTheoBaoCaoTongHopDonViTable = () => {
...
const HoSoTheoBaoCaoTongHopDonViWrapper = () => (
  <ButtonActionProvider>
    <HoSoTheoBaoCaoTongHopDonViTable />
  </ButtonActionProvider>
);
export default HoSoTheoBaoCaoTongHopDonViWrapper;
