...
const HoSoTheoChiTieuSoHoaTable = () => {
  ...
  useEffect(() => {
    dispatch(
      SearchHoSoTheoChiTieuSoHoa(hoSoTheoBaoCaoTongHopContext.searchParams)
    );
...
const HoSoTheoChiTieuSoHoaWrapper = () => (
  <ButtonActionProvider>
    <HoSoTheoChiTieuSoHoaTable />
  </ButtonActionProvider>
);
export default HoSoTheoChiTieuSoHoaWrapper;
