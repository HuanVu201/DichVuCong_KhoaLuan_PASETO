...
const HoSoTheoTiepNhanHoSoTrucTuyenTable = () => {
  ...
  useEffect(() => {
    dispatch(
      SearchHoSoTheoTiepNhanTrucTuyen(hoSoTheoBaoCaoTongHopContext.searchParams)
    );
...
const HoSoTheoTiepNhanHoSoTrucTuyenWrapper = () => (
  <ButtonActionProvider>
    <HoSoTheoTiepNhanHoSoTrucTuyenTable />
  </ButtonActionProvider>
);
export default HoSoTheoTiepNhanHoSoTrucTuyenWrapper;
