...
import { SearchHoSoTheoBaoCaoTongHop, SearchHoSoTheoBaoCaoTongHopDonVi } from "@/features/hoso/redux/action";
...
const HoSoTheoBaoCaoTongHopDonVi2Table = () => {
  ...
  useEffect(() => {
    dispatch(
      SearchHoSoTheoBaoCaoTongHopDonVi(hoSoTheoBaoCaoTongHopContext.searchParams)
    );
...
const HoSoTheoBaoCaoTongHopDonVi2Wrapper = () => (
  <ButtonActionProvider>
    <HoSoTheoBaoCaoTongHopDonVi2Table />
  </ButtonActionProvider>
);
export default HoSoTheoBaoCaoTongHopDonVi2Wrapper;
