...
export const ThemKenhTinCon = ({ handlerClose, visible, folderId }: { handlerClose: () => void, visible: boolean, folderId: string; }) => {
    ...
    const onFinish: FormProps["onFinish"] = (values) => {
        dispatch(AddKenhTin({ ...values, maKenhTinCha: folderId }))
        handleCancel()
    }
    const handleCancel = () => {
        form.resetFields()
    ...
    return (
        <AntdModal title="Thêm mới kênh tin con" handlerCancel={handleCancel} visible={visible} footer={null}
