...
export const DSTaiLieuHDSDDetail = () => {
    ...
    return (
        <AntdModal title="Thêm mới tài liệu hướng dẫn sử dụng" width={1000} visible={DSTaiLieuHDSDContext.DSTaiLieuHDSDVisible} handlerCancel={handleCancel} footer={null}>
                    ...
                    <Col >
                        ...
                        >
                            {/* <RegularUpload
                                ...
                                maxCount={1}
                                form={form} /> */}
                            <AntdUploadPublicFile form={form} fieldName="tepDinhKem" folderName="DSTLHDSD" dinhKem={dinhKem} />

                        </Form.Item>
                    </Col>
                    <Col >
                        <Form.Item
                            label="Tài liệu dành cho"
                            name="taiLieuDanhCho"
                        >
                            <AntdSelect style={{ width: '200px' }} allowClear options={[
