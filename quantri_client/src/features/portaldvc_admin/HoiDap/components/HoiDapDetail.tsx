...
export const HoiDapDetail = () => {
    ...
    return (
        <AntdModal title={HoiDapContext.hoiDapId ? "Cập nhật hỏi đáp" : "Thêm mới hỏi đáp"} width={1000} visible={HoiDapContext.hoiDapVisible} handlerCancel={handleCancel} footer={null}>
