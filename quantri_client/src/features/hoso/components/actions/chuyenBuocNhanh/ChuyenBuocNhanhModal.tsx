...
const ChuyenBuocNhanhModal = ({setSearchHoSoParams}: {setSearchHoSoParams : React.Dispatch<React.SetStateAction<ISearchHoSo>>}) => {
    ...
    // </AntdModal>
    return <AntdModal title="Xác nhận chuyển bước nhanh" visible={true} onOk={onOk} confirmLoading={btnLoading} onCancel={handleCancel} okText={"Đồng ý"}>
        <p>Chuyển bước xử lý các hồ sơ đã tích chọn người xử lý tiếp</p>
    </AntdModal>
}
