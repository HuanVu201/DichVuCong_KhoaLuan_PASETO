...
import { TaiLieuDienTuDetail } from "./TaiLieuDienTuDetail"
import { CaretDownOutlined } from "@ant-design/icons"
import { GetDanhSachKetQuaCanBoRequest, GetDanhSachKetQuaResponse, GetKetQuaByURLRequest, giayToSoHoaApi } from "@/features/giaytosohoa/services"
...
const DanhSachKhoSoHoaDVCQG = ({ form, handleCancel}: { form: FormInstance<IHoSo>; handleCancel: () => void}) => {
    ...
    useEffect(() => {
        (async () => {
            const body : GetDanhSachKetQuaCanBoRequest = {
            ...
            setLoading(true)
            const res = await giayToSoHoaApi.DanhSachGiayToKhoQuocGiaCanBo(body)
            setLoading(false)
