...
import { PhieuYeuCauBoSungTrucTuyen } from "@/pages/dvc/MauPhieu/documents/pdf/PhieuYeuCauBoSungTrucTuyen/PhieuYeuCauBoSungTrucTuyen";
...
export const XuatPhieuModal = ({ visible, handlerClose, lyDoBoSung, setNewFile, urlPhieu, setUrlPhieu, onChangeLyDo, setOnChangeLyDo, maGiayToHoSo, setMaGiayToHoSo, form, loadingPhieu, setLoadingPhieu }:
   {
      visible: boolean; handlerClose: () => void; lyDoBoSung: string | undefined,
   ...
   const onSave = (urlDinhKem: string | undefined, signed: boolean = false) => {
      if (urlDinhKem) {
         ...
         togglerSinged(form.getFieldValue("dinhKemBoSung"), signed)
   ...
   return <AntdModal title="PHIẾU YÊU CẦU BỔ SUNG HỒ SƠ" width={"100%"} fullsizeScrollable visible={visible} handlerCancel={handlerCancel} footer={
      ...
      <Spin spinning={loadingPhieu} 
        ...
        >
         <PhieuYeuCauBoSungTrucTuyen lyDoBoSung={lyDoBoSung}
