...
export interface TiepNhanHoSoTrucTuyenProps extends BaseActionProps{
    actionName : string
}
// sử dụng comp này bọc ngoài do không thể sử dụng customhook, và các hook bth ở trong useMemo, useEffect
export const TiepNhanHoSoTrucTuyenWrapper = (props: TiepNhanHoSoTrucTuyenProps) => {
    
    return <TiepNhanHoSoTrucTuyen {...props}></TiepNhanHoSoTrucTuyen>
}

const TiepNhanHoSoTrucTuyen = ({actionName, colorCode, iconName}: TiepNhanHoSoTrucTuyenProps) => {
