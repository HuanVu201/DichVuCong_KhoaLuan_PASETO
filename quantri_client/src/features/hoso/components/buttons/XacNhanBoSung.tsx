...
export interface XacNhanBoSungProps extends BaseActionProps {
  actionName: string;
}
// sử dụng comp này bọc ngoài do không thể sử dụng customhook, và các hook bth ở trong useMemo, useEffect
export const XacNhanBoSungWrapper = (props: XacNhanBoSungProps) => {
  return <XacNhanBoSung {...props}></XacNhanBoSung>;
};
...
const XacNhanBoSung = ({
  ...
  const onClick = () => {
    if (buttonActionContext.selectedHoSos.length) {
      buttonActionContext.setXacNhanBoSungModalVisible(true);
    } else {
