    ...
    const columns = useMemo(() : ColumnsType<ITruongHopThuTuc> => {
        return [
            ...
            },
            {
                ...
                render : (_, record) => {
                    return <>
                        {record.khongCoNgayHenTra ? <p>Thủ tục không quy định ngày hẹn trả</p> : <>
                        <p>- Trực tiếp: {record.thoiGianThucHien} (giờ)</p>
                        <p>- Trực tuyến: {record.thoiGianThucHienTrucTuyen} (giờ)</p>
                        </>}
