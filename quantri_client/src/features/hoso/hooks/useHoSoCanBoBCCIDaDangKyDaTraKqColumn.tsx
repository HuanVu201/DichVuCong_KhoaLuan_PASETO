...
export const useHoSoCanBoBCCIDaDangKyDaTraKqColumn = (
  ...
  > => {
    return [
      ...
      {
        title: "Ngày đăng ký",
        key: "ngayDangKyBuuDien",
        align: 'center',
        render: (_, record) => {
          return record?.ngayDangKyBuuDien ? <p style={{ fontSize: 16, textAlign: "center" }}>
            {dayjs(record.ngayDangKyBuuDien).format(FORMAT_DATE)}
          </p> : <p></p>
        }
      },
      {
        title: "Ngày BCCI trả kết quả",
        key: "ngayTraBuuDien",
        align: 'center',
        render: (_, record) => {
          return record?.ngayTraBuuDien ? <p style={{ fontSize: 16, textAlign: "center" }}>
            {dayjs(record.ngayTraBuuDien).format(FORMAT_DATE)}
          </p> : <p></p>
        }
      },
      {
          ...
          return (
            ...
            >
              ...
              {nhanKqQuaBCCI.phiThuHo ? (
                <span>{getCurrency(nhanKqQuaBCCI.phiThuHo)}</span>
              ) : null}
