        ...
        return [
            ...
            },
            {
                ...
                render: (_, record, idx) => {
                    ...
                    // </>
                    return <UploadTable hideUpload={true} setDataSource={setDataSource} dinhKem={record.fileDinhKem} folderName={hoSo?.maHoSo} colDinhKemName={"fileDinhKem"} rowNumber={idx} />
                }
            },
            {
