...
export interface ISearchDonViThuTuc extends IBasePagination, IBaseSearch, IPickSearch<IDonViThuTuc, "maTTHC" | "donViId" | "officeCode"> {
    donViQuanLy?: string
}
