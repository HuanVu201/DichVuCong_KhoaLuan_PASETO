...
export interface IPhiLePhiContext {
    ...
    updatePhiLePhiCSDLModalVisible: boolean;
    setUpdatePhiLePhiCSDLModalVisible: React.Dispatch<React.SetStateAction<boolean>>;
}
...
export const PhiLePhiProvider = ({ children }: IWithChildren) => {
    ...
    const [updatePhiLePhiCSDLModalVisible, setUpdatePhiLePhiCSDLModalVisible] = useState<boolean>(false)
    // thêm các hàm search cho các tabs ở đây
    return <PhiLePhiContext.Provider value={{
        setUpdatePhiLePhiCSDLModalVisible,updatePhiLePhiCSDLModalVisible,
