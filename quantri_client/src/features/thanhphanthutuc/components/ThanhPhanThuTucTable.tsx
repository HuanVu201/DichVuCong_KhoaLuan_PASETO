...
import { INoiDungGoiTin } from "@/features/lienThongQLVB/models";
import { UpdateThanhPhanThuTucCSDLModal } from "./UpdateThanhPhanThuTucCSDLModal";
      ...
      {searchParams.truongHopId && truongHopThuTucContext.truongHopThuTucId ? (
        <>
          ...
          {thanhPhanThuTucContext.thanhPhanThuTucModalVisible ? (
           ...
           {thanhPhanThuTucContext.capNhatThanhPhanThuTucCSDLTTHCModalVisible ? (
            <UpdateThanhPhanThuTucCSDLModal setSearchParams={setSearchParams} />
          ) : null}
        </>
      ) : (
        <></>
