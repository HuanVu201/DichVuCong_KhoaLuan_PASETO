...
export interface IThanhPhanThuTucContext{
    ...
    capNhatThanhPhanThuTucCSDLTTHCModalVisible: boolean;
    setCapNhatThanhPhanThuTucCSDLTTHCModalVisible: React.Dispatch<React.SetStateAction<boolean>>;
}
...
export const ThanhPhanThuTucProvider = ({children}: IWithChildren) => {
    ...
    const [capNhatThanhPhanThuTucCSDLTTHCModalVisible, setCapNhatThanhPhanThuTucCSDLTTHCModalVisible] = useState<boolean>(false)
    // thêm các hàm search cho các tabs ở đây
    return <ThanhPhanThuTucContext.Provider value={{thanhPhanThuTucId, setThanhPhanThuTucId, thanhPhanThuTucModalVisible, setThanhPhanThuTucModalVisible,setCapNhatThanhPhanThuTucCSDLTTHCModalVisible,capNhatThanhPhanThuTucCSDLTTHCModalVisible}}>
        {children}
