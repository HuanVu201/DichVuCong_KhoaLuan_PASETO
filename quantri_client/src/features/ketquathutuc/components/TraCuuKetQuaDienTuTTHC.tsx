...
export const TraCuuKetQuaDienTuTTHCTable = () => {
  ...
  const onSearch = async (values: ISearchGiayToSoHoa) => {
    await dispatch(SearchGiayToSoHoa(values))
  ...
  const handleCancel = () => {
    KetQuaThuTucContext.seTraCuuKetQuaTTHCModalVisible(false);
  }
  return (
    <AntdModal title="Tra cứu kết quả giải quyết thủ tục hành chính đã trích xuất của thủ tục" visible={true} handlerCancel={handleCancel} fullsizeScrollable footer={<>
