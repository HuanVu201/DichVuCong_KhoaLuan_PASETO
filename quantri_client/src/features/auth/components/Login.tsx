            ...
            <div className='d-flex justify-content-center mt-3'>
                <Form style={{ width: 450 }} form={form} name='login' onFinish={onFinish} initialValues={{ email: "", password: "" }}>
                    ...
                    {useSecurityCode
                        ?
                        (<>
                            <label className='form-label fs-6 fw-bolder text-dark'>Mã bảo mật</label>
                            <Form.Item name="securityCode" hasFeedback rules={[{ required: true, message: 'Vui lòng nhập mã bảo mật' }]}>
                                <Input.Password placeholder='Mã bảo mật' style={{ minHeight: '38px' }} ></Input.Password>
                            </Form.Item>
                        </>)
                        : null}
