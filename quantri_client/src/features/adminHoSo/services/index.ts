...
export type AdminKetThucXuLyNhieuHoSosParams = {
    ids: string[];
...
class AdminHoSoService extends Service.BaseApi implements Omit<Service.ICrud<IHoSo>, "Delete"> {
    ...
    AdminKetThucXuLyNhieuHoSo(params: AdminKetThucXuLyNhieuHoSosParams): AxiosResponseWrapper<IResult<any>> {
        return axiosInstance.post(this._urlSuffix + "/ketthucxulynhieuhosos", params)
    }
