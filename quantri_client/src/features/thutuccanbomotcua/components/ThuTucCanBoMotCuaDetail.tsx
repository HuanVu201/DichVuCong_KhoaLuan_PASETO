...
import "@/features/portaldvc/DanhMucThuTuc/components/DetailThuTucPortal.scss";
import {
  Checkbox,
  Col,
  DatePicker,
...
import {
  IGoiTinThuTucQuocGia,
  IQuyetDinhCongBo,
} from "@/features/portaldvc/DanhMucThuTuc/components/DetailThuTucPortal";
...
export const ThuTucCanBoMotCuaDetail = () => {
    ...
    if (thuTuc?.goiTinThuTucQG) {
      ...
      obj.THANHPHANHOSO?.map((item1: any) => {
        item1.GIAYTO?.map((item2: any) => {
          ...
          tmp_thanhPhanHoSo += `<td>${
            item2.TENGIAYTO ? item2.TENGIAYTO.replace(/\n/g, "<br>") : ""
          }</td>`;
          ...
          <table style={{ width: "100%" }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                >
                  <div
                    dangerouslySetInnerHTML={{ __html: goiTin?.moTa || "" }}
                  />
                </td>
              </tr>
            </tbody>
